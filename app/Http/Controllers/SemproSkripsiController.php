...
class SemproSkripsiController extends Controller
{
    ...
    public function isi_form_nilai_sempro_skripsi_dospem_kprd($id)
    {
        ...
        return view('kaprodi/magang_skripsi/form_nilai_sempro', compact('data', 'id', 'form_dosbing'));
    }
    ...
    public function isi_form_nilai_sempro_skripsi_dosji1_kprd($id)
    {
        ...
        return view('kaprodi/magang_skripsi/form_nilai_sempro_dosji1', compact('data', 'id', 'form_peng1'));
    }
    ...
    public function isi_form_nilai_sempro_skripsi_dosji2_kprd($id)
    {
        ...
        return view('kaprodi/magang_skripsi/form_nilai_sempro_dosji2', compact('data', 'id', 'form_peng2'));
    }
