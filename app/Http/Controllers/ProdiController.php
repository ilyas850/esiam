...
class ProdiController extends Controller
{
  ...
  public function rekap_perkuliahan()
  {
    ...
    return view('adminprodi/perkuliahan/rekap_perkuliahan', compact('data', 'tahun', 'tipe', 'namaperiodetahun', 'namaperiodetipe', 'idtahun', 'idtipe'));
  }
