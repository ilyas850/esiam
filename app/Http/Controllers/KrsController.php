...
class KrsController extends Controller
{
  public function krs()
  {
    ...
    if ($waktu_krs == null) {
      ...
      if ($c == 1) {
        $cekbyr = ($daftar + $awal + ($spp1 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == 2) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + ($spp2 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == '201') {
        $cekbyr = ($daftar + $awal + ($dsp * 91 / 100) + $spp1 + ($spp2 * 82 / 100)) - $total_semua_dibayar;
      } elseif ($c == 3) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + ($spp3 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == 4) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + ($spp4 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == '401') {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + ($spp4 * 82 / 100)) - $total_semua_dibayar;
      } elseif ($c == 5) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + ($spp5 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == 6) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + ($spp6 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == '601') {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + ($spp6 * 82 / 100)) - $total_semua_dibayar;
      } elseif ($c == 7) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + $spp6 + ($spp7 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == 8) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + $spp6 + $spp7 + ($spp8 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == '801') {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + $spp6 + $spp7 + ($spp8 * 82 / 100)) - $total_semua_dibayar;
      } elseif ($c == 9) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + $spp6 + $spp7 + $spp8 + ($spp9 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == 10) {
        $cekbyr = ($daftar + $awal + $dsp + $spp1 + $spp2 + $spp3 + $spp4 + $spp5 + $spp6 + $spp7 + $spp8 + $spp9 + ($spp10 * 16.6 / 100)) - $total_semua_dibayar;
      } elseif ($c == '1001') {
