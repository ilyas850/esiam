...
{
    public function dosenluar_home()
    {
    ...
    function entri_rps($id)
    {
        ...
        return view('dosenluar/pengajaran/form_rps', compact('id', 'data', 'pertemuan'));
    }
    ...
    function edit_rps($id)
    {
        ...
        return view('dosenluar/pengajaran/edit_form_rps', compact('id', 'data', 'pertemuan', 'rps'));
    }
    ...
    public function cekmhs_dsn_his($id)
    {
        ...
        return view('dosenluar/list_mhs_dsn_his', ['ck' => $kelas_gabungan, 'ids' => $id]);
    }
    ...
    public function input_bap($id)
    {
        ...
        return view('dosenluar/form_bap', compact('id', 'jam', 'nilai_pertemuan', 'rps', 'cek_mk'));
    }
    ...
    public function edit_absen($id)
    {
        ...
        return view('dosenluar/edit_absen', [
            'idk' => $id_kurperiode,
            'abs' => $data,
            'cross_absen' => $cross_students,
            'id' => $id,
    ...
    public function edit_bap($id)
    {
        ...
        return view('dosenluar/edit_bap', compact('id', 'bap', 'rps', 'jam', 'cek_mk'));
    }
    ...
    public function download_absensi($id)
    {
        ...
        $all_abs = Absensi_mahasiswa::join('bap', 'absensi_mahasiswa.id_bap', '=', 'bap.id_bap')
            ->join('student_record', 'absensi_mahasiswa.id_studentrecord', '=', 'student_record.id_studentrecord')
            ->where('bap.id_kurperiode', $id)
            ->where('bap.status', 'ACTIVE')
            ->select('absensi_mahasiswa.absensi', 'absensi_mahasiswa.id_studentrecord', 'bap.pertemuan')
    ...
    public function pedoman_khusus_dsn_luar()
    {
        ...
        return view('dosenluar/pedoman_khusus', compact('data'));
    }
