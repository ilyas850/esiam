...
<?php $__env->startSection('content'); ?>
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form class="form" role="form" action="<?php echo e(url('filter_bap_gugusmutu')); ?>" method="POST">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-table"></i> Rekap Perkuliahan <b><?php echo e($namaperiodetahun); ?> -
                        <?php echo e($namaperiodetipe); ?></b></h3>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="cek_bap_gugusmutu/<?php echo e($key->id_kurperiode); ?>" class="btn btn-info btn-xs"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/gugusmutu/perkuliahan/bap_perkuliahan.blade.php ENDPATH**/ ?>