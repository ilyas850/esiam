            ...
            <div class="box-body">
                ...
                <div class="modal fade" id="addgugusmutu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <form method="post" action="<?php echo e(url('post_gugusmutuprodi')); ?>" enctype="multipart/form-data">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <center>
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                            data-target="#modalUpdateGugusmutuprodi<?php echo e($key->id); ?>"
                                            title="klik untuk edit"><i class="fa fa-edit"></i></button>
                                        <a href="/hapusgugusmutuprodi/<?php echo e($key->id); ?>" class="btn btn-danger btn-xs"
                            ...
                            <div class="modal fade" id="modalUpdateGugusmutuprodi<?php echo e($key->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/put_gugusmutuprodi/<?php echo e($key->id); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/sadmin/user/gugusmutuprodi.blade.php ENDPATH**/ ?>