...
<body>
    <table width="100%">
        <tr>
            ...
            <td>
                <center>
                    <img src="<?php echo e(asset('images/kop.png')); ?>" width="200" height="70" alt=""
                        align="right" />
                </center>
            </td>
        </tr>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <center><?php echo e($item->tanggal); ?></center>
                    </td>
                    <td>
...
<?php /**PATH /var/www/html/resources/views/dosen/cetak_jurnal.blade.php ENDPATH**/ ?>