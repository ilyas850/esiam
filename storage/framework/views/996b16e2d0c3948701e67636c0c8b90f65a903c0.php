<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('data_mahasiswa_aktif_admin')); ?>"><i class="fa fa-circle-o"></i> Mahasiswa Aktif</a>
            </li>
            ...
            <li><a href="<?php echo e(url('mhs_ta')); ?>"><i class="fa fa-circle-o"></i>Mahasiswa Tugas Akhir</a></li>
            <li><a href="<?php echo e(url('kartu_ujian_mhs')); ?>"><i class="fa fa-circle-o"></i>Kartu Ujian Mahasiswa</a></li>
            <li><a href="<?php echo e(url('record_pembayaran_mahasiswa')); ?>"><i class="fa fa-circle-o"></i>Pembayaran
                    Mahasiswa</a></li>
            <li><a href="<?php echo e(url('record_sertifikat_mahasiswa')); ?>"><i class="fa fa-circle-o"></i>Sertifikat
                    Mahasiswa</a></li>
            <li><a href="<?php echo e(url('pengalaman_kerja_mahasiswa')); ?>"><i class="fa fa-circle-o"></i>Pengalaman Kerja
                    Mahasiswa</a></li>
        </ul>
    </li>
    <li class="treeview">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo e(url('show_user')); ?>"><i class="fa fa-circle-o"></i> User Mahasiswa</a></li>
            <li><a href="<?php echo e(url('data_admin')); ?>"><i class="fa fa-circle-o"></i> User Dosen Dalam</a></li>
            <li><a href="<?php echo e(url('data_dosen_luar')); ?>"><i class="fa fa-circle-o"></i> User Dosen Luar</a></li>
            <li><a href="<?php echo e(url('data_admin_prodi')); ?>"><i class="fa fa-circle-o"></i> User Admin Prodi</a></li>
            <li><a href="<?php echo e(url('data_gugusmutu_prodi')); ?>"><i class="fa fa-circle-o"></i> User Gugus Mutu</a></li>
            <li><a href="<?php echo e(url('user_microsoft')); ?>"><i class="fa fa-circle-o"></i>User Microsoft</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo e(url('approve_krs')); ?>"><i class="fa fa-circle-o"></i>Data Approve KRS</a></li>
            <li><a href="<?php echo e(url('data_krs')); ?>"><i class="fa fa-circle-o"></i>Data KRS Per MK</a></li>
            <li><a href="<?php echo e(url('summary_krs')); ?>"><i class="fa fa-circle-o"></i>Data KRS Per T.A.</a></li>
            <li><a href="<?php echo e(url('nilai_khs')); ?>"><i class="fa fa-circle-o"></i>Data Nilai KHS</a></li>
            <li><a href="<?php echo e(url('rekap_krs_angkatan')); ?>"><i class="fa fa-circle-o"></i>Data KRS Per Angkatan</a></li>
            <li><a href="<?php echo e(url('krs-manual')); ?>"><i class="fa fa-circle-o"></i>KRS Manual</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo e(url('jadwal_perkuliahan')); ?>"><i class="fa fa-circle-o"></i> Jadwal Perkuliahan</a>
            </li>
            <li><a href="<?php echo e(url('rekap_perkuliahan')); ?>"><i class="fa fa-circle-o"></i> Rekap Perkuliahan</a>
            </li>
        </ul>
    </li>
    <li class="treeview">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('soal_uts_uas')); ?>"><i class="fa fa-circle-o"></i> Soal UTS dan UAS</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo e(url('no_transkrip')); ?>"><i class="fa fa-circle-o"></i> Nomor Transkrip Nilai</a></li>
            <li><a href="<?php echo e(url('transkrip_nilai')); ?>"><i class="fa fa-circle-o"></i> Transkrip Nilai
                    Sementara</a></li>
            <li><a href="<?php echo e(url('transkrip_nilai_final')); ?>"><i class="fa fa-circle-o"></i> Transkrip Nilai
                    Final</a></li>
            <li><a href="<?php echo e(url('nilai_mhs')); ?>"><i class="fa fa-circle-o"></i> Rekap Nilai Mahasiswa</a></li>
            <li><a href="<?php echo e(url('input_nilai_mhs_admin')); ?>"><i class="fa fa-circle-o"></i> Input Nilai Mahasiswa</a>
            </li>
        </ul>
    </li>
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('data_prausta')); ?>"><i class="fa fa-circle-o"></i> Mahasiswa PraUSTA</a>
            </li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-th"></i> <span>Master Penangguhan</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="/master_kategori_penangguhan"><i class="fa fa-circle-o"></i> Kategori Penangguhan</a></li>
...
<?php /**PATH /var/www/html/resources/views/layouts/side_sadmin.blade.php ENDPATH**/ ?>