...
<head>
    ...
    <!-- daterange picker -->
    <link rel="stylesheet"
        href="<?php echo e(asset('adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css')); ?>">
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('adminlte/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')); ?>">
...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <?php echo $__env->yieldContent('notif_user'); ?>
                             ...
                             document.getElementById('logout-form').submit();"
                               ...
                               document.getElementById('logout-form').submit();"
                                ...
                                <?php elseif(Auth::user()->role == 5): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_dsn_luar/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 6): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_kaprodi/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 7): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_wadir1/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 11): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_prausta/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 9): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_prodi/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 8): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_bauk/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 10): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_wadir3/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                <?php elseif(Auth::user()->role == 12): ?>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="/change_pass_gugusmutu/<?php echo e(Auth::user()->id); ?>"
                                                class="btn btn-default btn-flat">Ubah Password</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo e(route('logout')); ?>"
            ...
            <section class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image">
                        <?php if(Auth::user()->role == 3): ?>
                            <img src="<?php echo e(asset('/foto_mhs/' . Auth::user()->username . '.jpg')); ?>" class="img-circle"
                                alt="User Image">
                        <?php else: ?>
                            <img src="/adminlte/img/default.jpg" class="img-circle" alt="User Image">
                        <?php endif; ?>
    ...
    <!-- bootstrap color picker -->
    <script src="<?php echo e(asset('adminlte/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')); ?>">
    </script>
    <!-- bootstrap time picker -->
