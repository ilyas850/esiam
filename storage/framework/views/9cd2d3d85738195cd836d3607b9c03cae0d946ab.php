...
<?php $__env->startSection('content_header'); ?>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(url('makul_diampu_kprd')); ?>">Data Matakuliah</a></li>
            <li><a href="<?php echo e(url('entri_bap_kprd/' . $bap->id_kurperiode)); ?>">BAP</a></li>
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo e(url('print_absensi_kprd/' . $bap->id_kurperiode)); ?>" class="btn btn-success btn-sm" target="_blank">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/kaprodi/bap/absensi_perkuliahan.blade.php ENDPATH**/ ?>