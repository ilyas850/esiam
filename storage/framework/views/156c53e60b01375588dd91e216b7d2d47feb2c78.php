                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="edit_nilai_pkl/<?php echo e($key->id_settingrelasi_prausta); ?>"
                                            class="btn btn-warning btn-xs" title="klik untuk edit"><i
                                                class="fa fa-edit"></i></a>
                                        <?php if($key->validasi == 0): ?>
                                            <a href="validate_nilai_pkl/<?php echo e($key->id_settingrelasi_prausta); ?>"
                                                class="btn btn-primary btn-xs" title="klik untuk validasi"><i
                                                    class="fa fa-check"></i></a>
                                        <?php else: ?>
                                            <a href="unvalidate_nilai_pkl/<?php echo e($key->id_settingrelasi_prausta); ?>"
