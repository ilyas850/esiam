    ...
    <section class="content-header">
        <div class="header-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(url('home')); ?>"><i class="fa fa-home"></i> Halaman Utama</a>
                    </li>
                    <li class="breadcrumb-item"><a href="<?php echo e(url('rekap_perkuliahan')); ?>">Rekap Perkuliahan</a></li>
                    <li class="breadcrumb-item"><a href="/cek_rekapan/<?php echo e($dtbp->id_kurperiode); ?>">Cek BAP</a></li>
...
<?php $__env->startSection('content'); ?>
    <section class="content">
        ...
        <div class="action-buttons mb-4">
            <a class="btn btn-primary btn-lg" href="/cek_rekapan/<?php echo e($dtbp->id_kurperiode); ?>">
                Kembali
            </a>
            <a class="btn btn-warning btn-lg ml-2" href="/cek_print_bap/<?php echo e($dtbp->id_bap); ?>" target="_blank">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-primary text-white text-center">
                ...
                <h4 class="mb-0">
                    Prodi <?php echo e($prd); ?> | Semester <?php echo e($tipe); ?> – <?php echo e($tahun); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($data->makul); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($data->nama); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($data->kelas); ?> / <?php echo e($data->semester); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($dtbp->media_pembelajaran); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($dtbp->jam_mulai); ?> - <?php echo e($dtbp->jam_selsai); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($dtbp->tanggal); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="attendance-section">
                            ...
                            <div class="attendance-stats">
                                <div class="attendance-item present">
                                    ...
                                    <div class="attendance-info">
                                        <div class="attendance-count"><?php echo e($dtbp->hadir); ?></div>
                                ...
                                <div class="attendance-item absent">
                                    ...
                                    <div class="attendance-info">
                                        <div class="attendance-count"><?php echo e($dtbp->tidak_hadir); ?></div>
                            ...
                            <div class="attendance-total mt-3">
                                <div class="total-students">
                                    ...
                                    <span class="total-number"><?php echo e($dtbp->hadir + $dtbp->tidak_hadir); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="material-content">
                    <p class="material-text"><?php echo e($dtbp->materi_kuliah); ?></p>
                </div>
            </div>
        </div>
                        ...
                        <div class="attachment-card">
                            ...
                            <div class="attachment-content">
                                ...
                                <?php if(($dtbp->link_materi) != null): ?>
                                    <a href="<?php echo e($dtbp->link_materi); ?>" target="_blank" class="btn btn-info btn-sm">
