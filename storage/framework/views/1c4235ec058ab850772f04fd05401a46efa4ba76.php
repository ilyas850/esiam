        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-md-12">
                        <a href="/input_bap_kprd/<?php echo e($bap->id_kurperiode); ?>" class="btn btn-success btn-flat">
                            <i class="fa fa-plus"></i> Input BAP
                        </a>
                        <a href="/sum_absen_kprd/<?php echo e($bap->id_kurperiode); ?>" class="btn btn-info btn-flat">
                            <i class="fa fa-list-alt"></i> Absensi Perkuliahan
                        </a>
                        <a href="/jurnal_bap_kprd/<?php echo e($bap->id_kurperiode); ?>" class="btn btn-warning btn-flat">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        <?php if($item->kurang_jam != null): ?>
                                            <div style="margin-top: 5px; color: red;">
                                                <small><i class="fa fa-warning"></i> Kurang:
                                                    <?php echo e(Carbon\Carbon::parse($item->kurang_jam)->format('H:i')); ?></small>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                        ...
                                        <?php if($item->komentar != null): ?>
                                            <div style="margin-top: 5px;">
                                                <button class="btn btn-warning btn-xs" data-toggle="modal"
                                                    data-target="#modalTambahKomentar<?php echo e($item->id_rps); ?>"
                                            ...
                                            <tr>
                                                <td class="text-center" style="border-right: 1px solid #ddd;">
                                                    <span class="text-green"
                                                        style="font-weight: bold; font-size: 16px;"><?php echo e($item->hadir); ?></span><br><small>Hadir</small>
                                                </td>
                                                <td class="text-center">
                                                    <span class="text-red"
                                                        style="font-weight: bold; font-size: 16px;"><?php echo e($item->tidak_hadir); ?></span><br><small>Absen</small>
                                                </td>
                                            </tr>
                                        </table>

                                        <?php if($item->hadir != null && $item->tidak_hadir != null): ?>
                                            <a href="/edit_absen_kprd/<?php echo e($item->id_bap); ?>"
                                                class="btn btn-success btn-xs btn-block">
                                                <i class="fa fa-edit"></i> Edit Absen
                                            </a>
                                        <?php elseif($item->hadir == null && $item->tidak_hadir == null): ?>
                                            <a href="/entri_absen_kprd/<?php echo e($item->id_bap); ?>"
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="/view_bap_kprd/<?php echo e($item->id_bap); ?>"
                                                class="btn btn-info btn-xs btn-flat" title="Lihat Detail">
                                                <i class="fa fa-eye"></i> Detail
                                            </a>

                                            <?php if($item->tanggal_validasi == '2001-01-01' or $item->tanggal_validasi == null): ?>
                                                <a href="/edit_bap_kprd/<?php echo e($item->id_bap); ?>"
                                                    class="btn btn-success btn-xs btn-flat" title="Edit BAP">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                                <a href="/delete_bap_kprd/<?php echo e($item->id_bap); ?>"
                                                    class="btn btn-danger btn-xs btn-flat" title="Hapus BAP"
                                                    onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                                                    <i class="fa fa-trash"></i> Hapus
                                                </a>
                                            <?php else: ?>
                                                <span class="btn btn-default btn-xs btn-flat disabled"
                                                    style="cursor: default; background-color: #f4f4f4;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/kaprodi/bap/bap.blade.php ENDPATH**/ ?>