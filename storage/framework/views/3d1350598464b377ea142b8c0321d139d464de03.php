...
<?php $__env->startSection('content_header'); ?>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(url('makul_diampu')); ?>"> Data Matakuliah yang diampu</a></li>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <?php else: ?>
                    ...
                    <a href="/input_kat/<?php echo e($ids); ?>" class="btn btn-success btn-sm">Input Nilai KAT
                        (<?php echo e($nilai->kat); ?>%)</a>
                    <a href="/input_uts/<?php echo e($ids); ?>" class="btn btn-info btn-sm">Input Nilai UTS
                        (<?php echo e($nilai->uts); ?>%)</a>
                    <a href="/input_uas/<?php echo e($ids); ?>" class="btn btn-warning btn-sm">Input Nilai UAS
                    ...
                    <div class="modal fade" id="editsettingnilai<?php echo e($nilai->id_settingnilai); ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <form method="post" action="/put_settingnilai_dsn_luar/<?php echo e($nilai->id_settingnilai); ?>">
                                <?php echo csrf_field(); ?>
                ...
                <div class="modal modal-danger fade" id="modal-danger">
                    <div class="modal-dialog">
                        <form action="<?php echo e(url('generate_nilai_akhir_dsn_luar')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="modal fade" id="addsettingnilai" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="post" action="<?php echo e(url('post_settingnilai_dsn_luar')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/dosenluar/list_mhs.blade.php ENDPATH**/ ?>