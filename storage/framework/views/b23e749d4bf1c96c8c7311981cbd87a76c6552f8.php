        ...
        <div class="col-md-6">
            <div class="box box-solid" style="border-top: 3px solid #dd4b39; min-height: 210px;">
                <div class="box-body">
                    ...
                    <div class="clearfix">
                        <a href="<?php echo e(url('download_pedoman_dsn_luar/' . $item->id_pedomanakademik)); ?>"
...
<?php /**PATH /var/www/html/resources/views/dosenluar/partials/pedoman_akademik_table.blade.php ENDPATH**/ ?>