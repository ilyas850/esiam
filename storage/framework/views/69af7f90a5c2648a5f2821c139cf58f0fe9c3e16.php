        ...
        <div class="col-md-6">
            <div class="box box-solid" style="border-top: 3px solid #dd4b39; min-height: 210px;">
                <div class="box-body">
                    ...
                    <div class="clearfix">
                        <a href="<?php echo e(url('download_pedoman_dsn_dlm/' . $item->id_pedomanakademik)); ?>" class="btn btn-warning">
...
<?php /**PATH /var/www/html/resources/views/dosen/partials/pedoman_akademik_list.blade.php ENDPATH**/ ?>