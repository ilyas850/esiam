        ...
        <div class="box box-primary profile-card">
            <div class="box-body">
                <div class="profile-header">
                    <img class="img-circle profile-avatar" src="<?php echo e($mhs->photo_url); ?>" alt="User profile picture">
                    <h3 class="profile-name"><?php echo e($mhs->nama); ?></h3>
                    <p class="profile-nim"><?php echo e($mhs->nim); ?></p>
                    <p class="profile-subtitle">
                        Ringkasan identitas mahasiswa yang aktif dipakai pada layanan akademik.
                    </p>

                    <div class="profile-tags">
                        <span class="profile-tag"><?php echo e($mhs->display_prodi ?: '-'); ?></span>
                        <span class="profile-tag"><?php echo e($mhs->kelas ?: '-'); ?></span>
                        <span class="profile-tag">Angkatan <?php echo e($mhs->angkatan ?: '-'); ?></span>
                    </div>
                </div>
                ...
                <div class="profile-stats">
                    <div class="profile-stat">
                        ...
                        <span class="profile-stat-value"><?php echo e($mhs->virtual_account ?: '-'); ?></span>
                    </div>
                    <div class="profile-stat">
                        <span class="profile-stat-label">Kontak Aktif</span>
                        <span class="profile-stat-value"><?php echo e($mhs->display_phone); ?></span>
                    </div>
                </div>

                <div class="profile-actions">
                    <a href="/ganti_foto/<?php echo e($mhs->nim); ?>" class="btn btn-default btn-block">
                        <i class="fa fa-camera"></i> Ganti Foto
                    </a>
                    <a href="<?php echo e($editProfileUrl); ?>" class="btn btn-success btn-block">
                ...
                <ul class="details-list">
                    <li class="details-item">
                        ...
                        <span class="details-value">
                            <span><?php echo e($mhs->username ?: '-'); ?></span>
                            <?php if($mhs->username): ?>
                    ...
                    <li class="details-item">
                        ...
                        <span class="details-value">
                            <span><?php echo e($mhs->password ?: '-'); ?></span>
                            <?php if($mhs->password): ?>
                    ...
                    <li class="details-item">
                        ...
                        <span class="details-value">
                            <span><?php echo e($mhs->nisn ?: '-'); ?></span>
                            <a class="btn btn-warning btn-xs" data-toggle="modal"
                                data-target="#modalUpdateNisn<?php echo e($mhs->idstudent); ?>" title="Edit NISN">
                    ...
                    <li class="details-item">
                        ...
                        <span class="details-value"><?php echo e($mhs->display_phone); ?></span>
                    </li>
                    <li class="details-item">
                        <span class="details-label">E-mail</span>
                        <span class="details-value"><?php echo e($mhs->display_email); ?></span>
                    </li>
                    <li class="details-item">
                        <span class="details-label">Virtual Account</span>
                        <span class="details-value">
                            <span><?php echo e($mhs->virtual_account ?: '-'); ?></span>
                            <?php if($mhs->virtual_account): ?>
                    ...
                    <div class="modal-body">
                        <form action="/put_nisn/<?php echo e($mhs->idstudent); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="nisn" value="<?php echo e($mhs->nisn); ?>">
                            </div>
        ...
        <div class="dashboard-hero">
            <div class="dashboard-hero-body">
                <div class="hero-content">
                    ...
                    <h2>Halo, <?php echo e($mhs->nama); ?></h2>
                    <p>
                    ...
                    <div class="hero-meta">
                        <span class="hero-badge"><?php echo e($tahun ? $tahun->periode_tahun : '-'); ?> <?php echo e($tipe ? $tipe->periode_tipe : ''); ?></span>
                        <span class="hero-badge">Paket Matakuliah: <?php echo e($dashboard['paket_count']); ?></span>
                        <span class="hero-badge">Matakuliah Mengulang: <?php echo e($dashboard['mengulang_count']); ?></span>
                        <span class="hero-badge">Informasi: <?php echo e($dashboard['info_count']); ?></span>
                    </div>
                </div>
                <div class="hero-spotlight">
                    ...
                    <ul class="hero-spotlight-list">
                        <li class="hero-spotlight-item">
                            ...
                            <span class="hero-spotlight-value"><?php echo e($dashboard['krs_status']); ?></span>
                            <span class="hero-spotlight-note"><?php echo e($dashboard['krs_schedule']); ?></span>
                        </li>
                        <li class="hero-spotlight-item">
                            <span class="hero-spotlight-label">Status EDOM</span>
                            <span class="hero-spotlight-value"><?php echo e($dashboard['edom_status']); ?></span>
                            <span class="hero-spotlight-note"><?php echo e($dashboard['edom_schedule']); ?></span>
                        </li>
                        <li class="hero-spotlight-item">
                            <span class="hero-spotlight-label">Informasi Kampus</span>
                            <span class="hero-spotlight-value"><?php echo e($dashboard['info_count']); ?> Info Aktif</span>
                ...
                <div class="summary-card summary-card-aqua">
                    <div class="summary-card-head">
                        ...
                        <div>
                            ...
                            <span class="summary-card-value"><?php echo e($tahun ? $tahun->periode_tahun : '-'); ?></span>
                        </div>
                    </div>
                    <span class="summary-card-note">Periode akademik aktif</span>
                    <span class="summary-card-meta">
                        <i class="fa fa-bookmark-o"></i>
                        <?php echo e($tipe ? $tipe->periode_tipe : '-'); ?>
                ...
                <div class="summary-card summary-card-green">
                    <div class="summary-card-head">
                        ...
                        <div>
                            ...
                            <span class="summary-card-value"><?php echo e($dashboard['krs_status']); ?></span>
                        </div>
                    </div>
                    <span class="summary-card-note">Akses jadwal pengisian KRS dari panel aktivitas.</span>
                    <span class="summary-card-meta">
                        <i class="fa fa-clock-o"></i>
                        <?php echo e($time && (int) $time->status === 1 ? 'Jadwal tersedia' : 'Menunggu jadwal'); ?>
                ...
                <div class="summary-card summary-card-yellow">
                    <div class="summary-card-head">
                        ...
                        <div>
                            ...
                            <span class="summary-card-value"><?php echo e($dashboard['edom_status']); ?></span>
                        </div>
                    </div>
                    <span class="summary-card-note">Pantau periode evaluasi dosen dari dashboard ini.</span>
                    <span class="summary-card-meta">
                        <i class="fa fa-clipboard"></i>
                        <?php echo e($edom && (int) $edom->status === 1 ? 'Periode berjalan' : 'Belum dibuka'); ?>
                ...
                <div class="summary-card summary-card-red">
                    <div class="summary-card-head">
                        ...
                        <div>
                            ...
                            <span class="summary-card-value"><?php echo e($dashboard['mengulang_count']); ?></span>
                        </div>
                    </div>
                    <span class="summary-card-note">Daftar matakuliah yang perlu perhatian akademik.</span>
                    <span class="summary-card-meta">
                        <i class="fa fa-repeat"></i>
                        <?php echo e($dashboard['mengulang_count'] > 0 ? 'Perlu ditinjau' : 'Aman'); ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="activity">
                    <div class="tab-panel-head">
                        ...
                        <span class="tab-panel-badge"><?php echo e($dashboard['info_count']); ?> Info Tersedia</span>
                    </div>
                            ...
                            <div class="box box-info schedule-card">
                                ...
                                <div class="box-body">
                                    <span class="schedule-status">
                                        <i class="fa fa-calendar-check-o"></i>
                                        <?php echo e($dashboard['krs_status']); ?>
                                    ...
                                    <div id="krs-countdown" class="countdown-box"
                                        data-target="<?php echo e($time && (int) $time->status === 1 ? $time->waktu_akhir : ''); ?>"
                                        data-message="menuju Penutupan Pengisian KRS">
                                        <?php if(!$time || (int) $time->status === 0): ?>
                                            Belum ada info perwalian
                                        <?php endif; ?>
                                    </div>
                                    <div class="activity-footer"><?php echo e($dashboard['krs_schedule']); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="box box-info schedule-card">
                                ...
                                <div class="box-body">
                                    <span class="schedule-status">
                                        <i class="fa fa-clipboard"></i>
                                        <?php echo e($dashboard['edom_status']); ?>
                                    ...
                                    <div id="edom-countdown" class="countdown-box"
                                        data-target="<?php echo e($edom && (int) $edom->status === 1 ? $edom->waktu_akhir : ''); ?>"
                                        data-message="menuju Penutupan Pengisian EDOM">
                                        <?php if(!$edom || (int) $edom->status === 0): ?>
                                            Belum ada info pengisian EDOM
                                        <?php endif; ?>
                                    </div>
                                    <div class="activity-footer"><?php echo e($dashboard['edom_schedule']); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="box box-primary panel-card announcement-panel">
                                        ...
                                        <ul class="announcement-list">
                                            <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="announcement-item">
                                                    ...
                                                    <div>
                                                        <a href="/lihat/<?php echo e($item->id_informasi); ?>" class="announcement-title">
                                                            <?php echo e($item->judul); ?>

                                                        </a>
                                                        <span class="announcement-meta">
                                                            <?php echo e(date('d-m-Y', strtotime($item->created_at))); ?> · <?php echo e($item->created_at->diffForHumans()); ?>

                                                        </span>
                                                        <div class="announcement-desc">
                                                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($item->deskripsi), 180)); ?>
                                ...
                                <div class="box-footer announcement-footer">
                                    <span class="text-muted pull-left hidden-xs">
                                        <?php if($info->count()): ?>
                                            Menampilkan <?php echo e($info->count()); ?> informasi terbaru.
                                        <?php else: ?>
                                            Belum ada informasi yang ditampilkan.
                                        <?php endif; ?>
                                    </span>
                                    <?php if($dashboard['calendar_url']): ?>
                                        <a href="<?php echo e($dashboard['calendar_url']); ?>" target="_blank" class="btn btn-default btn-sm">
                ...
                <div class="tab-pane" id="timeline">
                    <div class="tab-panel-head hidden-xs">
                        ...
                        <span class="tab-panel-badge"><?php echo e($dashboard['paket_count']); ?> Matakuliah</span>
                    </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td align="center"><span class="row-index"><?php echo e($index + 1); ?></span></td>
                                        ...
                                        <td>
                                            <span class="desktop-course-title"><?php echo e($item->makul); ?></span>
                                            <span class="desktop-course-meta"><?php echo e($item->kode); ?></span>
                                        </td>
                                        <td align="center">
                            ...
                            <div class="course-card">
                                <button type="button" class="course-card-toggle">
                                    <div class="course-card-top">
                                        <div>
                                            <div class="course-card-title"><?php echo e($item->kode); ?> / <?php echo e($item->makul); ?></div>
                                            <div class="course-card-meta"><?php echo e($item->nama_kurikulum); ?></div>
                                        </div>
                                ...
                                <div class="course-card-body">
                                    <div class="course-card-grid">
                                        <div class="course-card-item">
                                            ...
                                            <span class="course-card-value"><?php echo e($item->prodi); ?></span>
                                        </div>
                                        <div class="course-card-item">
                                            <span class="course-card-label">Semester</span>
                                            <span class="course-card-value"><?php echo e($item->semester); ?></span>
                                        </div>
                                        <div class="course-card-item">
                                            <span class="course-card-label">Angkatan</span>
                                            <span class="course-card-value"><?php echo e($item->angkatan); ?></span>
                                        </div>
                                        <div class="course-card-item">
                ...
                <div class="tab-pane" id="settings">
                    <div class="tab-panel-head hidden-xs">
                        ...
                        <span class="tab-panel-badge"><?php echo e($dashboard['mengulang_count']); ?> Matakuliah</span>
                    </div>
                    ...
                    <div class="desktop-course-table table-wrap hidden-xs">
                        <table id="example3" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data_mengulang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td align="center"><span class="row-index"><?php echo e($index + 1); ?></span></td>
                                        <td align="center"><?php echo e($item->nama_kurikulum); ?></td>
                                        <td align="center"><?php echo e($item->prodi); ?></td>
                                        ...
                                        <td align="center"><span class="desktop-value-pill"><?php echo e($item->nilai_AKHIR); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
                    ...
                    <div class="mobile-course-list visible-xs-block">
                        <?php $__empty_1 = true; $__currentLoopData = $data_mengulang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="course-card">
                                <button type="button" class="course-card-toggle">
                                    <div class="course-card-top">
                                        <div>
                                        ...
                                        <div class="text-right">
                                            <span class="course-card-badge status-danger"><?php echo e($item->nilai_AKHIR); ?></span>
                                            <div class="course-card-chevron">
                                                <i class="fa fa-chevron-down"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="course-card-body">
                                    <div class="course-card-grid">
                                        ...
                                        <div class="course-card-item">
                                            ...
                                            <span class="course-card-value"><?php echo e($item->nilai_AKHIR); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
