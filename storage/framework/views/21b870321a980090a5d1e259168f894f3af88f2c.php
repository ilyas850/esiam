                        ...
                        <?php $__currentLoopData = $makul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <span style="font-size: 15px; font-weight: bold; color: #3c8dbc;"><?php echo e($item->makul); ?></span><br>
                                ...
                                <td style="vertical-align: middle;">
                                    <div class="row" style="margin-bottom: 5px; border-bottom: 1px dashed #ddd; padding-bottom: 5px;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <div style="margin-bottom: 5px;">
                                        <?php if($item->id_rps == null): ?>
                                            <a href="/entri_rps_kprd/<?php echo e($item->id_kurperiode); ?>"
                                                class="btn btn-success btn-xs btn-block">
                                                <i class="fa fa-plus"></i> Input RPS
                                            </a>
                                        <?php else: ?>
                                            <div class="btn-group">
                                                <a href="/edit_rps_kprd/<?php echo e($item->id_kurperiode); ?>" class="btn btn-info btn-xs"
                                                    title="Edit RPS"><i class="fa fa-pencil"></i> RPS</a>
                                                <a href="/cekmhs_dsn_kprd/<?php echo e($item->id_kurperiode); ?>" class="btn btn-primary btn-xs"
                                                    title="Entri Nilai"><i class="fa fa-list-ol"></i> Nilai</a>
                                                <a href="/entri_bap_kprd/<?php echo e($item->id_kurperiode); ?>" class="btn btn-warning btn-xs"
                                                    title="BAP"><i class="fa fa-newspaper-o"></i> BAP</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="btn-group">
                                        <a href="/export_xlsnilai_kprd/<?php echo e($item->id_kurperiode); ?>" class="btn btn-default btn-xs"
                                            title="Export Excel">
                                            <i class="fa fa-file-excel-o text-green"></i>
                                        </a>
                                        <a href="/unduh_pdf_nilai_kprd/<?php echo e($item->id_kurperiode); ?>" class="btn btn-default btn-xs"
                                            title="Export PDF">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo e(url('simpan_soal_uts_dsn_kprd')); ?>" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipe_ujian_uts" class="form-control" required>
                                                        <?php if($item->tipe_ujian_uts): ?>
                                                            <option value="<?php echo e($item->tipe_ujian_uts); ?>"><?php echo e($item->tipe_ujian_uts); ?></option>
                                                        <?php endif; ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="cetak_soal_uts" class="form-control" required>
                                                        <?php if($item->cetak_soal_uts): ?>
                                                            <option value="<?php echo e($item->cetak_soal_uts); ?>"><?php echo e($item->cetak_soal_uts); ?></option>
                                                        <?php endif; ?>
                            ...
                            <div class="modal fade" id="modalUploadSoalUas<?php echo e($item->id_kurperiode); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo e(url('simpan_soal_uas_dsn_kprd')); ?>" method="post"
                                                enctype="multipart/form-data">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipe_ujian_uas" class="form-control" required>
                                                        <?php if($item->tipe_ujian_uas): ?>
                                                            <option value="<?php echo e($item->tipe_ujian_uas); ?>"><?php echo e($item->tipe_ujian_uas); ?></option>
                                                        <?php endif; ?>
                                                        <option value="TATAP MUKA">TATAP MUKA</option>
                                                        <option value="TAKE HOME">TAKE HOME</option>
                                                        <option value="PROJECT">PROJECT</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="cetak_soal_uas" class="form-control" required>
                                                        <?php if($item->cetak_soal_uas): ?>
                                                            <option value="<?php echo e($item->cetak_soal_uas); ?>"><?php echo e($item->cetak_soal_uas); ?></option>
                                                        <?php endif; ?>
                                                        <option value="YA">YA</option>
                                                        <option value="TIDAK">TIDAK</option>
                                                    </select>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" readonly cols="20" rows="5"><?php echo e($item->komentar_uts); ?></textarea>
                                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Isi Komentar:</label>
                                                <textarea class="form-control" readonly cols="20" rows="5"><?php echo e($item->komentar_uas); ?></textarea>
                                            </div>
                                            <button type="button" class="btn btn-default pull-right"
                                                data-dismiss="modal">Tutup</button>
                                            <div class="clearfix"></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/kaprodi/matakuliah/makul_diampu_dsn.blade.php ENDPATH**/ ?>