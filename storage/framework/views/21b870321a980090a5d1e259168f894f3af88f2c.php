                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $makul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <?php elseif($item->id_rps != null): ?>
                                            <a href="cekmhs_dsn_kprd/<?php echo e($item->id_kurperiode); ?>"
                                                class="btn btn-info btn-xs" title="Klik untuk entri nilai">Nilai</a>
                                            <a href="entri_bap_kprd/<?php echo e($item->id_kurperiode); ?>"
                                ...
                                <td>
                                    <center>
                                        <a href="/export_xlsnilai_kprd/<?php echo e($item->id_kurperiode); ?>"
                                            class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"
                                                title="Klik untuk export nilai .xls">
                                            </i></a>
                                        <a href="/unduh_pdf_nilai_kprd/<?php echo e($item->id_kurperiode); ?>"
