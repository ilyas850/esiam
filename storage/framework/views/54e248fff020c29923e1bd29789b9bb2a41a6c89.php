                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $makul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <?php elseif($item->id_rps != null): ?>
                                            <a href="cekmhs_dsn/<?php echo e($item->id_kurperiode); ?>" class="btn btn-info btn-xs"
                                            ...
                                            <a href="entri_bap/<?php echo e($item->id_kurperiode); ?>" class="btn btn-warning btn-xs"
                                                ...
                                                BAP </a>
                                            <a href="edit_rps/<?php echo e($item->id_kurperiode); ?>" class="btn btn-success btn-xs"
                                ...
                                <td>
                                    <center>
                                        <a href="/export_xlsnilai/<?php echo e($item->id_kurperiode); ?>"
                                            class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"
                                                title="Klik untuk export nilai .xls">
                                            </i></a>
                                        <a href="/unduh_pdf_nilai/<?php echo e($item->id_kurperiode); ?>"
