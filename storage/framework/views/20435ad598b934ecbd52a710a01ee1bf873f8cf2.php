        ...
        <table id="example1" class="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th width="35%"><center>Nama Dosen</center></th>
          ...
          <tbody>
            ...
            <?php $__currentLoopData = $user_dsn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keydsn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><center><?php echo e($keydsn->nik); ?></center></td>
                <td><center>

                  <?php if(($keydsn->username) == null): ?>
                    <form action="<?php echo e(url('saveuser_dsn_luar')); ?>" method="post">
                      ...
                      <button type="submit" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="right">Generate</button>
                    </form>
                  ...
                  <?php elseif(($keydsn->username) != null): ?>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><form method="POST" action="<?php echo e(url('resetuserdsn_luar')); ?>">
                           <input type="hidden" name="password" value="<?php echo e($keydsn->username); ?>">
                        ...
                        <li><form action="/hapususerdsn_luar/<?php echo e($keydsn->id_user); ?>" method="post">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/sadmin/data_user_dosen_luar.blade.php ENDPATH**/ ?>