        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="<?php echo e(url('pedoman_akademik_dsn_kprd')); ?>" id="reset_search"
                ...
                <div id="pedoman-list-container">
                    <?php echo $__env->make('kaprodi.partials.pedoman_akademik_list', ['pedoman' => $pedoman], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(function() {
            ...
            var baseUrl = "<?php echo e(url('pedoman_akademik_dsn_kprd')); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/kaprodi/pedoman_akademik.blade.php ENDPATH**/ ?>