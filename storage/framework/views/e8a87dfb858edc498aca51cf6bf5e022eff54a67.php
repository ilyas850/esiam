...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        #table-undurdiri th.sticky,
        #table-undurdiri td.sticky {
        ...
        #table-undurdiri thead th.sticky {
            background-color: #dd4b39 !important;
            color: #fff !important;
            z-index: 200 !important;
            border-bottom: 2px solid #c43c2e !important;
        }

        /* Column 1: No */
        #table-undurdiri .sticky-col-1 {
            left: 0px;
            width: 50px;
            min-width: 50px;
            max-width: 50px;
        ...
        #table-undurdiri .sticky-col-4 {
            left: 330px;
            width: 250px;
            min-width: 250px;
            max-width: 250px;
            border-right: 3px solid #dd4b39 !important;
            box-shadow: 4px 0 8px -2px rgba(0, 0, 0, 0.2);
        }

        /* Striped rows - MUST use !important to override base sticky background */
        #table-undurdiri.table-striped>tbody>tr:nth-of-type(odd)>td.sticky {
            background-color: #f9f9f9 !important;
        }

        #table-undurdiri.table-striped>tbody>tr:nth-of-type(even)>td.sticky {
            background-color: #ffffff !important;
        }

        /* Hover state - Also must use !important */
        #table-undurdiri.table-hover>tbody>tr:hover>td.sticky {
    ...
    <section class="content">
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-list"></i> Data Pengajuan Mengundurkan Diri Mahasiswa</h3>
            ...
            <div class="box-body">
                <table id="table-undurdiri" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            var table = $('#table-undurdiri').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('cek_trans_pengajuan/2')); ?>",
                    data: function (d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/sadmin/pengajuan/hasil_transaction_pengajuan_undurdiri.blade.php ENDPATH**/ ?>