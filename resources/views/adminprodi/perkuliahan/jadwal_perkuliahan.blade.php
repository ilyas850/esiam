...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-calendar"></i> Jadwal Perkuliahan Prodi</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary box-filter-panel">
            ...
            <form action="{{ url('jadwal_kuliah_prodi') }}" method="GET">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            ...
                            <div class="btn-action-group">
                                ...
                                <a href="{{ url('jadwal_kuliah_prodi') }}" class="btn btn-default" title="Reset ke Periode Aktif">
                                    <i class="fa fa-refresh"></i> Reset
                                </a>
                                <a href="{{ url('export_jadwal_perkuliahan_prodi') }}?id_periodetahun={{ $id_periodetahun }}&id_periodetipe={{ $id_periodetipe }}"
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="fa fa-calendar"></i> Jadwal Perkuliahan 
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted" style="padding: 30px;">
                                    ...
                                    <span style="font-size: 14px;">Belum ada jadwal perkuliahan yang terdaftar untuk program studi ini pada periode terpilih.</span>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
