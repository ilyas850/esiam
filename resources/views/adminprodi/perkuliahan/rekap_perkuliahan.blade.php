...
@section('content')
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form class="form" role="form" action="{{ url('filter_rekap_perkuliahan_prodi') }}" method="POST">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $key)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/cek_rekapan_prodi/{{ $key->id_kurperiode }}" class="btn btn-info btn-xs" title="Lihat Detail BAP">
