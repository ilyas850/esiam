...
@section('content')
    <section class="content">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <form class="form" role="form" action="{{ url('view_mhs_bim_ta') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-xs-3">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Data Dosen Pembimbing Tugas Akhir</h3>
            </div>
            <div class="box-body">
                                ...
                                <td>
                                    <center>
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                            data-target="#modalUpdateDospemTa{{ $keydsn->id_settingrelasi_prausta }}"
                                            title="klik untuk edit">Edit dosen</button>
                                    </center>
                                </td>
                            </tr>
                            <div class="modal fade" id="modalUpdateDospemTa{{ $keydsn->id_settingrelasi_prausta }}"
                                tabindex="-1" aria-labelledby="modalUpdateDospemTa" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/put_dospem_ta/{{ $keydsn->id_settingrelasi_prausta }}"
                                                method="post">
                                                @csrf
                                                @method('put')
