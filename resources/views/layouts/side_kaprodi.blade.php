<ul class="sidebar-menu" data-widget="tree">
    ...
    <li><a href="{{ url('makul_ulang_kprd') }}"><i class="fa fa-repeat"></i> <span>Matakuliah Mengulang</span></a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="{{ url('jadwal_seminar_proposal_kprd') }}"><i class="fa fa-circle-o"></i> Seminar
                    Proposal</a></li>
            <li><a href="{{ url('jadwal_sidang_ta_kprd') }}"><i class="fa fa-circle-o"></i> Sidang TA</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
