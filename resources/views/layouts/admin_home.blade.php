      ...
      <div class="box-body">
        <div class="row">
          <form class="form" role="form" action="{{url('add_ta')}}" method="POST">
            {{ csrf_field() }}
            <div class="col-xs-7">
              <input type="text" class="form-control" name="periode_tahun" placeholder="T.A.2019/2020" required>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="datepicker3" value="{{ $now }}" disabled>
                </div>
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="datepicker" name="waktu_akhir" value="{{ $time->waktu_akhir }}" required>
                </div>
              </div>
            </div>
          </div>
        ...
        <form method="POST" action="{{ url('delete_time_krs') }}">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" value="{{ $time->waktu_awal }} sampai {{ $time->waktu_akhir}}" readonly>
              </div>
            </div>
            <input type="hidden" name="status" value="0">
            <input type="hidden" name="id" value="{{$time->id}}">
                <button type="button" class="btn btn-warning btn-lg btn-block" data-toggle="modal" data-target="#modal-warning">
                  Tutup Pengisian KRS
                </button>
