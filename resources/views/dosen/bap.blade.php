        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-md-12">
                        <a href="/input_bap/{{ $bap->id_kurperiode }}" class="btn btn-success btn-flat">
                            <i class="fa fa-plus"></i> Input BAP
                        </a>
                        <a href="/sum_absen/{{ $bap->id_kurperiode }}" class="btn btn-info btn-flat">
                            <i class="fa fa-list-alt"></i> Absensi Perkuliahan
                        </a>
                        <a href="/jurnal_bap/{{ $bap->id_kurperiode }}" class="btn btn-warning btn-flat">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        @if ($item->hadir != null && $item->tidak_hadir != null)
                                            <a href="/edit_absen/{{ $item->id_bap }}" class="btn btn-success btn-xs btn-block">
                                                <i class="fa fa-edit"></i> Edit Absen
                                            </a>
                                        @elseif ($item->hadir == null && $item->tidak_hadir == null)
                                            <a href="/entri_absen/{{ $item->id_bap }}" class="btn btn-warning btn-xs btn-block">
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="/view_bap/{{ $item->id_bap }}" class="btn btn-info btn-xs btn-flat" title="Lihat Detail">
                                                <i class="fa fa-eye"></i> Detail
                                            </a>

                                            @if ($item->tanggal_validasi == '2001-01-01' or $item->tanggal_validasi == null)
                                                <a href="/edit_bap/{{ $item->id_bap }}" class="btn btn-success btn-xs btn-flat" title="Edit BAP">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                                <a href="/delete_bap/{{ $item->id_bap }}" class="btn btn-danger btn-xs btn-flat" title="Hapus BAP" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
