    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <a href="/sum_absen_his/{{$bap->id_kurperiode}}" class="btn btn-info">Absensi Perkuliahan</a>
                <a href="/jurnal_bap_his/{{$bap->id_kurperiode}}" class="btn btn-warning">Jurnal Perkuliahan</a>
                <br><br>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td><center>
                                    <a href="/view_history_bap/{{$item->id_bap}}" class="btn btn-info btn-xs" title="klik untuk lihat"> <i class="fa fa-eye"></i></a>  
                                </center></td>
                            </tr>
                        @endforeach
                    </tbody>
