...
@section('content_header')
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/view_bap_his/{{$dtbp->id_kurperiode}}">History BAP</a></li>
...
@section('content')
    <section class="content">
        <div class="box box-info">
            <div class="box-body">
                <a class="btn btn-success" href="/view_bap_his/{{$dtbp->id_kurperiode}}">Kembali</a>
                
                <a class="btn btn-warning" href="/print_bap/{{$dtbp->id_bap}}" target="_blank"><i class="fa fa-print"></i> PRINT</a>
