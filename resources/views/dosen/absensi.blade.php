                ...
                <div class="box-body">
                    <div class="callout callout-info">
                        ...
                        <p>Secara default, semua mahasiswa ditandai <strong>HADIR</strong>. Silakan ubah status bagi
                            mahasiswa yang tidak hadir. Gunakan tombol <strong>Tambah Mahasiswa Lintas Kelas</strong> jika ada mahasiswa dari kelas paralel lain yang mengikuti sesi perkuliahan ini.</p>
                    </div>
                    ...
                    <table class="table table-bordered table-hover" id="tabel-absensi">
                        ...
                        <tbody>
                            ...
                            {{-- Mahasiswa Lintas Kelas yang sudah tersimpan sebelumnya --}}
                            @if(isset($cross_absen) && count($cross_absen) > 0)
                                @foreach ($cross_absen as $item)
                                    <tr class="warning baris-lintas-kelas" data-sr-id="{{ $item->id_studentrecord }}">
                                        <td class="text-center">{{ count($absen) + $loop->iteration }}</td>
                                        <td>
                                            <strong>{{ $item->nama }}</strong>
