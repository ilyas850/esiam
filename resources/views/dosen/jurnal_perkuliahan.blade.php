...
@section('content')
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <a href="/print_jurnal/{{ $bap->id_kurperiode }}" class="btn btn-success" target="_blank">Print</a>
                <a href="/download_jurnal/{{ $bap->id_kurperiode }}" class="btn btn-info">Download</a>
                <br><br>
