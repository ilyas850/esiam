    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="/entri_bap/{{ $bap->id_kurperiode }}" class="btn btn-default btn-sm">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="/print_jurnal/{{ $bap->id_kurperiode }}" class="btn btn-success btn-sm" target="_blank">
                        <i class="fa fa-print"></i> Print
                    </a>
                    <a href="/download_jurnal/{{ $bap->id_kurperiode }}" class="btn btn-info btn-sm">
