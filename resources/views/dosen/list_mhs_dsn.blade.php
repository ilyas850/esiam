        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                @else
                    ...
                    <a href="/input_kat_dsn/{{ $ids }}" class="btn btn-success btn-sm">Input Nilai KAT
                        ({{ $nilai->kat }}%)</a>
                    <a href="/input_uts_dsn/{{ $ids }}" class="btn btn-info btn-sm">Input Nilai UTS
                        ({{ $nilai->uts }}%)</a>
                    <a href="/input_uas_dsn/{{ $ids }}" class="btn btn-warning btn-sm">Input Nilai UAS
                        ({{ $nilai->uas }}%)</a>
                    ...
                    <div class="modal fade" id="editsettingnilai{{ $nilai->id_settingnilai }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <form method="post" action="/put_settingnilai_dsn_dlm/{{ $nilai->id_settingnilai }}">
                                @csrf
                                @method('put')
                ...
                <div class="modal fade" id="addsettingnilai" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="post" action="{{ url('post_settingnilai_dsn_dlm') }}"
