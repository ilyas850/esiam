    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Data Mahasiswa Bimbingan SEMPRO</h3>
            </div>
            <div class="box-body">
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-info btn-xs"
                                            href="/record_bim_sempro_skripsi_dsn_dlm/{{ $key->id_settingrelasi_prausta }}">Cek
                                            Bimbingan</a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="/download_bap_sempro_skripsi_dsn_dlm/{{ $key->id_settingrelasi_prausta }}"
