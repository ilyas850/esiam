                ...
                <form action="{{ url('save_edit_absensi') }}" method="post">
                    ...
                    <div class="box-body">
                        <div class="callout callout-info">
                            ...
                            <p>Ubah status kehadiran mahasiswa sesuai dengan data yang benar. Anda juga dapat menambahkan mahasiswa dari kelas paralel lain menggunakan tombol <strong>Tambah Mahasiswa Lintas Kelas</strong>.</p>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="35%">
                                        ...
                                        <div class="btn-group btn-group-xs pull-right">
                                            <button type="button" class="btn btn-default" id="tandaiHadirSemua">Hadir Semua</button>
                                            <button type="button" class="btn btn-default" id="tandaiAlpaSemua">Alpa Semua</button>
                                        </div>
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @if(isset($cross_absen) && count($cross_absen) > 0)
                                    @foreach ($cross_absen as $item)
                                        <tr class="warning baris-lintas-kelas" data-sr-id="{{ $item->id_studentrecord }}">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm">
                                                    <label class="btn btn-success {{ ($item->absensi ?? '') == 'ABSEN' ? 'active' : '' }}">
                                                        <input type="radio" name="absensi_radio[{{ $item->id_studentrecord }}]"
    ...
    @section('script')
        <script>
            $(document).ready(function () {
                // Delegated event listener untuk radio button group
                ...
                function cariMahasiswa() {
                    ...
                    $.ajax({
                        url: "{{ url('cari_mhs_lintas_kelas/' . $id) }}",
                        type: "GET",
                        data: { q: q },
                        dataType: "json",
