                ...
                <div class="box-body">
                    <div class="form-group">
                        <div class="callout callout-warning">
                            <p><i class="fa fa-info-circle"></i> Ubah status kehadiran mahasiswa sesuai dengan data yang benar. Anda juga dapat menambahkan mahasiswa dari kelas paralel lain menggunakan tombol <strong>Tambah Mahasiswa Lintas Kelas</strong>.</p>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped" id="tabel-absen-dsn">
                        <thead>
                            <tr>
                                <th>
                                    <center>No</center>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio"
                                                    ...
                                                    {{ ($item->absensi == 'ABSEN' || !empty($item->hadir_di_kelas_lain)) ? 'checked' : '' }}>
                                            </label>
                                        </div>
                                        @if(!empty($item->hadir_di_kelas_lain))
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio"
                                                    ...
                                                    {{ ($item->absensi == 'ALFA' && empty($item->hadir_di_kelas_lain)) ? 'checked' : '' }}>
                                            </label>
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div class="radio">
                                            <label>
                                                <input type="radio"
                                                    ...
                                                    {{ ($item->absensi == 'IZIN' && empty($item->hadir_di_kelas_lain)) ? 'checked' : '' }}>
                                            </label>
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div class="radio">
                                            <label>
                                                <input type="radio"
                                                    ...
                                                    {{ ($item->absensi == 'SAKIT' && empty($item->hadir_di_kelas_lain)) ? 'checked' : '' }}>
                                            </label>
                                        </div>
                                    </td>
                                    <td align="center">-</td>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio"
                                                        name="absensi_radio[{{ $item->id_studentrecord }}]"
                                                        value="{{ $item->id_studentrecord }},ABSEN"
                                                        {{ ($item->absensi == 'ABSEN' || empty($item->absensi)) ? 'checked' : '' }}>
                                                </label>
                                            </div>
                                        </td>
                                        <td align="center">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="callout callout-warning">
                            <p><i class="fa fa-info-circle"></i> Cari mahasiswa yang memprogram mata kuliah yang sama dari kelas paralel lain. Saat perubahan absensi disimpan, kehadiran otomatis disinkronkan ke rekap kelas asalnya.</p>
                        </div>
                        <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateNomorUrut() {
                $('#tabel-absen-dsn tbody tr').each(function (index) {
            ...
            $(document).on('click', '.btn-pilih-mhs', function () {
                ...
                var noUrut = $('#tabel-absen-dsn tbody tr').length + 1;
                ...
                $('#tabel-absen-dsn tbody').append(newRow);
