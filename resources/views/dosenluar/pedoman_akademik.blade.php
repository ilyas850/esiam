        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ url('pedoman_akademik_dsn_luar') }}" id="reset_search"
                ...
                <div id="pedoman-list-container">
                    @include('dosenluar.partials.pedoman_akademik_table', ['pedoman' => $pedoman])
                </div>
            </div>
        </div>
    </section>
...
@section('script')
    <script>
        $(function() {
            ...
            var baseUrl = "{{ url('pedoman_akademik_dsn_luar') }}";
