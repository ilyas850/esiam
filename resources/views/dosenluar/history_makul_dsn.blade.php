                ...
                <tbody>
                    ...
                    @foreach ($makul as $item)
                        <tr>
                            ...
                            <td><center>
                            <a href="cekmhs_dsn_hislr/{{$item->id_kurperiode}}" class="btn btn-info btn-xs" title="klik untuk cek mahasiswa"><i class="fa fa-users"></i></a>
                            </center></td>
                            <td><center>
                            ...
                            <td><center>
                                <a href="view_bap_his_dsn/{{$item->id_kurperiode}}" class="btn btn-warning btn-xs" title="klik untuk cek BAP"> <i class="fa fa-file-text"></i></a>
