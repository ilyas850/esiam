                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <div style="margin-bottom: 5px;">
                                        ...
                                        @else
                                            <div class="btn-group">
                                                <a href="edit_rps_dsnlr/{{ $item->id_kurperiode }}" class="btn btn-info btn-xs"
                                                    title="Edit RPS"><i class="fa fa-pencil"></i> RPS</a>
                                                <a href="cekmhs/{{ $item->id_kurperiode }}" class="btn btn-primary btn-xs"
                                    ...
                                    <div class="btn-group">
                                        <a href="/export_xlsnilai_dsn/{{ $item->id_kurperiode }}" class="btn btn-default btn-xs"
                                            title="Export Excel">
                                            <i class="fa fa-file-excel-o text-green"></i>
                                        </a>
                                        <a href="/unduh_pdf_nilai_dsn/{{ $item->id_kurperiode }}" class="btn btn-default btn-xs"
                                            title="Export PDF">
