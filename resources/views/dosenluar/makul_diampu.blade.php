                    ...
                    @foreach ($makul as $item)
                        <tr>
                          ...
                          <td>{{$item->id_kurperiode}}</td>
                            <td><center>
                              <a href="cekmhs/{{$item->id_kurperiode}}" class="btn btn-info btn-xs">Entri Nilai</a>
                            </center></td>
                            <td><center>
                              <a href="entri_bap_dsn/{{$item->id_kurperiode}}" class="btn btn-warning btn-xs"> Entri BAP</a>
                            </center></td>
                            <td><center>
