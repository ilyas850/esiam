        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{ url('print_absensi_dsn/' . $bap->id_kurperiode) }}" class="btn btn-success btn-sm" target="_blank">
                        <i class="fa fa-print"></i> Print
                    </a>
                    <a href="{{ url('download_absensi_dsn/' . $bap->id_kurperiode) }}" class="btn btn-warning btn-sm">
