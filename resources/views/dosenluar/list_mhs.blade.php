        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                @else
                    ...
                    <a href="/input_kat/{{ $ids }}" class="btn btn-success btn-sm">Input Nilai KAT
                        ({{ $nilai->kat }}%)</a>
                    <a href="/input_uts/{{ $ids }}" class="btn btn-info btn-sm">Input Nilai UTS
                        ({{ $nilai->uts }}%)</a>
                    <a href="/input_uas/{{ $ids }}" class="btn btn-warning btn-sm">Input Nilai UAS
                        ({{ $nilai->uas }}%)</a>
                    {{-- <a href="/input_akhir/{{ $ids }}" class="btn btn-danger btn-sm">Input Nilai AKHIR</a> --}}
                    ...
                    <div class="modal fade" id="editsettingnilai{{ $nilai->id_settingnilai }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <form method="post" action="/put_settingnilai_dsn_luar/{{ $nilai->id_settingnilai }}">
                                @csrf
                                @method('put')
                ...
                <div class="modal fade" id="addsettingnilai" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="post" action="{{ url('post_settingnilai_dsn_luar') }}"
