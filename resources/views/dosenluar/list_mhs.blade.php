...
@section('content')
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <a href="/input_kat/{{ $ids }}" class="btn btn-success btn-sm">Input Nilai KAT</a>
                <a href="/input_uts/{{ $ids }}" class="btn btn-info btn-sm">Input Nilai UTS</a>
                <a href="/input_uas/{{ $ids }}" class="btn btn-warning btn-sm">Input Nilai UAS</a>
