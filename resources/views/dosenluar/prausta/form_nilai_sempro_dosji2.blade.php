...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('penguji_sempro_dsnlr') }}">Data mahasiswa Seminar Proposal</a></li>
...
@section('content')
    <section class="content">
        ...
        <form class="" action="{{ url('simpan_nilai_sempro_dosji2_dsnlr') }}" method="post"
            ...
            <div class="box box-warning">
                <div class="box-header">
                    <h3 class="box-title"><b>Form Penilaian Dosen Penguji 2</b> </h3>
                </div>
                <div class="box-body">
