...
@section('content')
    <section class="content">
        <div class="box box-info">
            <div class="box-body">
                <a class="btn btn-success" href="/entri_bap_dsn/{{ $dtbp->id_kurperiode }}">Kembali</a>

                <a class="btn btn-warning" href="/print_bap_dsn/{{ $dtbp->id_bap }}" target="_blank"><i class="fa fa-print"></i>
                    PRINT</a>
