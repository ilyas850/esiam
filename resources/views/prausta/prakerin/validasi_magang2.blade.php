...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Validasi Magang 2</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="{{ url('data_val_magang2_mahasiswa') }}">
                        ...
                        <span class="label label-warning" style="margin-left: 5px;">{{ $total }}</span>
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content" style="padding: 15px 12px;">
                ...
                <!-- Form & Tabel Data Validasi Magang 2 -->
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($item->validasi_baak == 'BELUM')
                                                @if (!empty($item->nilai_huruf))
                                                    <button type="button" class="btn btn-info btn-xs btn-flat btn-confirm-action"
                                                            ...
                                                            data-title="Konfirmasi Validasi Magang 2"
                                                            data-message="Apakah Anda yakin ingin memvalidasi akhir Magang 2 mahasiswa: <br><b>{{ $item->nama }} ({{ $item->nim }})</b>?"
                                            ...
                                            @elseif ($item->validasi_baak == 'SUDAH')
                                                <button type="button" class="btn btn-danger btn-xs btn-flat btn-confirm-action"
                                                        ...
                                                        data-title="Konfirmasi Batal Validasi Magang 2"
