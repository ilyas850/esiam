                                ...
                                <td>
                                    <center>
                                        <a href="edit_nilai_prakerin/{{ $key->id_settingrelasi_prausta }}"
                                            class="btn btn-warning btn-xs" title="klik untuk edit"><i class="fa fa-edit"></i></a>
                                        @if ($key->validasi == 0)
                                            <a href="validate_nilai_prakerin/{{ $key->id_settingrelasi_prausta }}"
                                                class="btn btn-primary btn-xs" title="klik untuk validasi"><i class="fa fa-check"></i></a>
                                        @else
                                            <a href="unvalidate_nilai_prakerin/{{ $key->id_settingrelasi_prausta }}"
                                                class="btn btn-danger btn-xs" title="klik untuk batal validasi"><i class="fa fa-close"></i></a>
                                        @endif
                                    </center>
                                </td>
                            </tr>
