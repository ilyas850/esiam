...
@section('content')
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title">Data Bimbingan Magang</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <form class="form" role="form" action="{{ url('filter_bim_magang_use_prodi') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="col-xs-3">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $key)
                            <tr>
                                ...
                                <td>
                                    <center> <a href="cek_bim_magang/{{ $key->id_settingrelasi_prausta }}"
