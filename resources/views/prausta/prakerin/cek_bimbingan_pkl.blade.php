    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Data Bimbingan PKL Mahasiswa</h3>
                <br><br>
                <table width="100%">
                    <tr>
                        <td>NIM</td>
            ...
            <div class="box-body">
                <form action="{{ url('download_bimbingan_prakerin') }}" method="post">
                    {{ csrf_field() }}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($key->file_bimbingan != null)
                                        <a href="/File Bimbingan PKL/{{ $key->idstudent }}/{{ $key->file_bimbingan }}"
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title">Draft & Laporan Akhir PKL Mahasiswa</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Laporan Akhir PKL</span>
                        <span class="info-box-number">
