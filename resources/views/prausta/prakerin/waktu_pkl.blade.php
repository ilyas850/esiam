                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="hapus_waktu_prausta/{{ $item->id_masterwaktu_prausta }}"
                                            class="btn btn-danger btn-xs" title="klik untuk hapus"><i
                                                class="fa fa-trash" onclick="return confirm('apakah anda yakin akan menghapus waktu ini ?')"></i></a>
                                    </center>
                                </td>
                            </tr>
                            <div class="modal fade" id="modalUpdateWaktu{{ $item->id_masterwaktu_prausta }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/put_waktu/{{ $item->id_masterwaktu_prausta }}" method="post">
                                                @csrf
                                                @method('put')
                                                <div class="row">
                                                    <div class="col-md-6">
