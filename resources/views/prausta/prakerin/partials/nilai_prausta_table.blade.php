                        ...
                        @foreach ($data as $key)
                            <tr>
                                ...
                                <td class="nilai-download">
                                    <a href="{{ url('/unduh_nilai_prakerin_b/' . $key->id_settingrelasi_prausta) }}"
                                        class="btn btn-info btn-xs" title="Unduh form pembimbing">
                                        <i class="fa fa-download"></i> Pembimbing
                                    </a>
                                    <a href="{{ url('/unduh_nilai_prakerin_c/' . $key->id_settingrelasi_prausta) }}"
                                ...
                                <td class="nilai-action">
                                    <div class="btn-group">
                                        <a href="{{ url($editRoute . '/' . $key->id_settingrelasi_prausta) }}"
