...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Validasi Magang 1</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="{{ url('data_val_magang_mahasiswa') }}">
                        ...
                        <span class="label label-success" style="margin-left: 5px;">{{ $total }}</span>
                    </a>
                </li>
                <li>
            ...
            <div class="tab-content" style="padding: 15px 12px;">
                ...
                <!-- Form & Tabel Data Validasi Magang 1 -->
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($item->validasi_baak == 'BELUM')
                                                @if (!empty($item->nilai_huruf))
                                                    <button type="button" class="btn btn-info btn-xs btn-flat btn-confirm-action"
                                                            ...
                                                            data-title="Konfirmasi Validasi Magang 1"
                                                            data-message="Apakah Anda yakin ingin memvalidasi akhir Magang 1 mahasiswa: <br><b>{{ $item->nama }} ({{ $item->nim }})</b>?"
                                            ...
                                            @elseif ($item->validasi_baak == 'SUDAH')
                                                <button type="button" class="btn btn-danger btn-xs btn-flat btn-confirm-action"
                                                        ...
                                                        data-title="Konfirmasi Batal Validasi Magang 1"
