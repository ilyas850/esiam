    ...
    <section class="content">
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Filter Data Sempro Mahasiswa</h3>
            </div>
        ...
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Data Seminar Proposal <b> {{ $namaperiodetahun }} - {{ $namaperiodetipe }} </b></h3>
            </div>
            <div class="box-body">
                                    ...
                                    <center>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="/atur_sempro/{{ $key->id_settingrelasi_prausta }}">Setting</a>
                                                </li>
                                                @if ($key->status == 'ACTIVE')
                                                    <li><a href="/nonatifkan_prausta_sempro/{{ $key->id_settingrelasi_prausta }}"
