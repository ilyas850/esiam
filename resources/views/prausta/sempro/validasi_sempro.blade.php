...
@section('content')
    <section class="content-header">
        <h1>
            Validasi Sempro
            <small>Validasi Akhir BAAK Seminar Proposal</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">PraUSTA</a></li>
            <li class="active">Validasi Sempro</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-file-text-o"></i> <b>Data Mahasiswa Peserta Sempro</b></h3>
                <div class="box-tools pull-right">
                    <span class="label label-info" style="font-size: 12px;">Total: {{ $total }} Mahasiswa</span>
                </div>
            </div>

            <div class="box-body" style="padding: 15px 12px;">
                ...
                <!-- Form & Tabel Data Validasi Sempro -->
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($item->validasi_baak == 'BELUM')
                                                @if (!empty($item->nilai_huruf))
                                                    <button type="button" class="btn btn-info btn-xs btn-flat btn-confirm-action"
                                                            ...
                                                            data-title="Konfirmasi Validasi Sempro"
                                                            data-message="Apakah Anda yakin ingin memvalidasi akhir Seminar Proposal mahasiswa: <br><b>{{ $item->nama }} ({{ $item->nim }})</b>?"
                                            ...
                                            @elseif ($item->validasi_baak == 'SUDAH')
                                                <button type="button" class="btn btn-danger btn-xs btn-flat btn-confirm-action"
                                                        ...
                                                        data-title="Konfirmasi Batal Validasi Sempro"
