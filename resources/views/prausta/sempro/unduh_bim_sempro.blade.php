...
<body>
    ...
    <table width="100%">
        <tr>
            <td>
                <center>
                    <h3><b>KARTU BIMBINGAN SEMPRO</b></h3>
                </center>
            </td>
        </tr>
    </table>
    ...
    <table width="100%">
        <tr>
            <td width="11%" style="font-size:85%"> <b>Judul Seminar Proposal</b> </td>
        ...
        <tr>
            ...
            <td style="font-size:85%">:</td>
            <td colspan="3" style="font-size:85%"><b>{{ $dospem->nama }}, {{ $dospem->akademik }}</b></td>
        </tr>
        <tr>
            <td style="font-size:85%"><b>Dosen Penguji 1</b></td>
            <td style="font-size:85%">:</td>
            <td colspan="3" style="font-size:85%"><b>
                    @if ($dospeng1 != null)
        ...
        <tr>
            <td style="font-size:85%"><b>Dosen Penguji 2</b></td>
            <td style="font-size:85%">:</td>
            <td colspan="3" style="font-size:85%"><b>
                    @if ($dospeng1 != null)
    ...
    <table width="100%">
        <tr>
            <td width="60%" align=center><span style="font-size:85%"></span></td>
            <td width="40%" align=left><span style="font-size:85%">Cikarang, .................................</span>
            </td>
        </tr>
    </table>
    <table width="100%">
        <tr>
            <td width="60%" align=center><span style="font-size:85%"></span></td>
            <td width="40%" align=left><span style="font-size:85%">Dosen Pembimbing</span></td>
        </tr>
    </table>
    <br><br><br>
    <table width="100%">
        <tr>
            <td width="60%" align=center><span style="font-size:85%"></span>
            </td>
            <td width="40%" align=left><span style="font-size:85%">({{ $dospem->nama }},
                    {{ $dospem->akademik }})</span>
            </td>
        </tr>
    </table>
</body>
