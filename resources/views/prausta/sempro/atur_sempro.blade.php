...
@section('content_header')
    <section class="content-header">
        <h1>
            Setting Jadwal Seminar Proposal Mahasiswa
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Halaman Utama</a></li>
            <li><a href="{{ url('data_sempro') }}">Data Sempro</a></li>
            <li class="active">Setting Sempro</li>
        </ol>
    </section>
@endsection
...
@section('content')
    <section class="content">
        <div class="box box-info">
            <form class="" action="{{ url('simpan_atur_sempro') }}" method="post"
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title"><b>Setting Seminar Proposal</b> </h3>
