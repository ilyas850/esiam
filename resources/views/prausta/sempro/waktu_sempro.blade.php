...
@section('content')
    ...
    @php
        ...
        $totalProdi = $data->pluck('prodi')->unique()->count();

        $totalBerjalan = $data->filter(function($item) use ($today) {
            return $today >= $item->set_waktu_awal && $today <= $item->set_waktu_akhir;
        })->count();

        $totalMendatang = $data->filter(function($item) use ($today) {
            return $today < $item->set_waktu_awal;
        })->count();
    @endphp
    ...
    <section class="content-header">
        <h1>
            Waktu Pelaksanaan SEMPRO
            <small>Manajemen jadwal dan batas waktu Seminar Proposal (SEMPRO)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li><a href="#">PraUSTA</a></li>
            <li class="active"><i class="fa fa-calendar"></i> Waktu SEMPRO</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($totalProdi) }} <small style="font-size: 13px; font-weight: normal; color: #777;">Prodi</small></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Belum Dimulai</span>
                        <span class="info-box-number">{{ number_format($totalMendatang) }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-list-alt text-primary"></i> Daftar Waktu Pelaksanaan SEMPRO</h3>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="vertical-align: middle;">
                                        <span class="badge bg-purple badge-tipe"><i class="fa fa-file-text-o"></i> SEMPRO</span>
                                    </td>
                                    <td style="vertical-align: middle;">
                                        <div>
    ...
    {{-- Modal Tambah Waktu Pelaksanaan SEMPRO --}}
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-custom modal-header-success">
                        ...
                        <h4 class="modal-title" id="addWaktuLabel">
                            <i class="fa fa-plus-circle"></i> Tambah Waktu Pelaksanaan SEMPRO
                        </h4>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-custom modal-header-info">
                        ...
                        <h4 class="modal-title" id="modalUpdateLabel">
                            <i class="fa fa-pencil-square-o"></i> Perbarui Waktu SEMPRO
                        </h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
