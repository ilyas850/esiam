...
<body>
    ...
    <table width="100%">
        <tr>
            <td>
                <center>
                    <h4><b>FORM PENILAIAN SIDANG TUGAS AKHIR / SKRIPSI</b> <br> (Dosen Penguji I)</h4>
    ...
    <table width="100%">
        ...
        <tr>
            <td width="18%">Program Studi</td>
            <td width="2%">: </td>
            <td width="80%">{{ $datadiri->prodi }}</td>
        </tr>
        <tr>
            <td width="18%">Waktu Sidang</td>
            <td width="2%">: </td>
            ...
            <td width="50%">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="80%" align=left style="font-size:85%"><span>Dosen Penguji I</span></td>
                    </tr>
                </table>
                <br><br><br><br><br>
                <table width="100%">
