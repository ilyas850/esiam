...
@section('content')
    ...
    @php
        ...
        $totalTA = $data->where('tipe_prausta', 'TA')->count();
        $totalSkripsi = $data->where('tipe_prausta', 'Skripsi')->count();
    ...
    <section class="content-header">
        <h1>
            Waktu Pelaksanaan TA & Skripsi
            <small>Manajemen jadwal dan batas waktu Tugas Akhir (TA) & Skripsi mahasiswa</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li><a href="#">PraUSTA</a></li>
            <li class="active"><i class="fa fa-calendar"></i> Waktu TA / Skripsi</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jadwal TA</span>
                        <span class="info-box-number">{{ number_format($totalTA) }}</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jadwal Skripsi</span>
                        <span class="info-box-number">{{ number_format($totalSkripsi) }}</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-list-alt text-primary"></i> Daftar Waktu Pelaksanaan TA & Skripsi</h3>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="vertical-align: middle;">
                                        @if ($item->tipe_prausta == 'TA')
                                            <span class="badge bg-blue badge-tipe"><i class="fa fa-book"></i> TA</span>
                                        @elseif ($item->tipe_prausta == 'Skripsi')
                                            <span class="badge bg-purple badge-tipe"><i class="fa fa-graduation-cap"></i> Skripsi</span>
                                        @else
    ...
    {{-- Modal Tambah Waktu Pelaksanaan TA/Skripsi --}}
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-custom modal-header-success">
                        ...
                        <h4 class="modal-title" id="addWaktuLabel">
                            <i class="fa fa-plus-circle"></i> Tambah Waktu Pelaksanaan TA/Skripsi
                        </h4>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-custom modal-header-info">
                        ...
                        <h4 class="modal-title" id="modalUpdateLabel">
                            <i class="fa fa-pencil-square-o"></i> Perbarui Waktu TA / Skripsi
                        </h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
