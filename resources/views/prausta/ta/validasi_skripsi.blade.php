...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Validasi Skripsi</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="padding: 15px 12px;">
                ...
                <!-- Form & Tabel Data Validasi Skripsi -->
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($item->validasi_baak == 'BELUM')
                                                @if (!empty($item->nilai_huruf))
                                                    <button type="button" class="btn btn-info btn-xs btn-flat btn-confirm-action"
                                                            ...
                                                            data-title="Konfirmasi Validasi Skripsi"
                                                            data-message="Apakah Anda yakin ingin memvalidasi akhir Skripsi mahasiswa: <br><b>{{ $item->nama }} ({{ $item->nim }})</b>?"
                                            ...
                                            @elseif ($item->validasi_baak == 'SUDAH')
                                                <button type="button" class="btn btn-danger btn-xs btn-flat btn-confirm-action"
                                                        ...
                                                        data-title="Konfirmasi Batal Validasi Skripsi"
