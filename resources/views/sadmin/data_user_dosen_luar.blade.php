          ...
          <tbody>
            ...
            @foreach ($user_dsn as $keydsn)
              <tr>
                ...
                <td><center>{{$keydsn->nik}}</center></td>
                <td><center>

                  @if (($keydsn->username) == null)
                    <form action="{{url('saveuser_dsn_luar')}}" method="post">
                  ...
                  @elseif(($keydsn->username) != null)
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><form method="POST" action="{{url('resetuserdsn_luar')}}">
                           <input type="hidden" name="password" value="{{$keydsn->username}}">
                        ...
                        <li><form action="/hapususerdsn_luar/{{ $keydsn->id_user }}" method="post">
