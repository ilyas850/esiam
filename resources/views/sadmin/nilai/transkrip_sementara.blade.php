        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th rowspan="2"><center>Kode MK</center></th>
              <th rowspan="2"><center>Nama Matakuliah</center></th>
          ...
          <tbody>
            ...
            @foreach ($data as $key)
              <tr>
                ...
                <td><center>{{$key->kode}}</center></td>
                <td>{{$key->makul}}</td>
                <td><center>{{$key->akt_sks}}</center></td>
                <td><center>{{$key->nilai_AKHIR}}</center></td>
                <td><center>{{$key->nilai_ANGKA}}</center></td>
                <td><center>{{$key->nilai_sks}}</center></td>
              </tr>
            @endforeach
            <tr>
