...
@section('content')
    <section class="content">
        <div class="box box-danger">
            ...
            <form class="form" role="form" action="{{ url('filter_master_ta') }}" method="POST">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-3">
        ...
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Data TA <b> {{ $namaperiodetahun }} - {{ $namaperiodetipe }} </b></h3>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($data_krs as $item)
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="cek_master_ta/{{ $item->id_settingrelasi_prausta }}"
