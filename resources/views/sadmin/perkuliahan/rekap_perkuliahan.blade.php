...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-file-text-o"></i> Rekap Perkuliahan</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary box-filter-panel">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-filter"></i> Filter & Pengaturan Rekap Perkuliahan</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                </div>
            </div>
            <form action="{{ url('filter_rekap_perkuliahan') }}" method="POST">
                @csrf
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="btn-action-group">
                                ...
                                <a href="{{ url('rekap_perkuliahan') }}" class="btn btn-default" title="Reset ke Periode Aktif">
                                    <i class="fa fa-refresh"></i> Reset
                                </a>
                                <a href="{{ url('export_rekap_perkuliahan') }}?id_periodetahun={{ $id_periodetahun }}&id_periodetipe={{ $id_periodetipe }}&id_prodi={{ $id_prodi }}"
                ...
                <table id="example8" class="table table-bordered table-striped table-hover" style="width: 100%;">
                    <thead>
                        <tr style="background-color: #f7f9fa;">
                            ...
                            <th style="width: 60px; text-align: center; vertical-align: middle;">BAP</th>
                            <th style="width: 130px; text-align: center; vertical-align: middle;">Download</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php $no = 1; @endphp
                        @forelse ($data as $key)
                            ...
                            <tr>
                                ...
                                <td align="center" style="vertical-align: middle;">
                                    <a href="{{ url('cek_rekapan/' . $key->id_kurperiode) }}" class="btn btn-primary btn-xs" title="Lihat Detail BAP Pertemuan">
                                        <i class="fa fa-eye"></i> Cek
                                    </a>
                                </td>
                                <td align="center" style="vertical-align: middle;">
                                    <a href="{{ url('download_bap_dosen/' . $key->id_kurperiode) }}" class="btn btn-danger btn-xs" title="Download Berkas BAP">
                                        <i class="fa fa-download"></i> BAP
                                    </a>
                                    <a href="{{ url('download_absensi_mhs/' . $key->id_kurperiode) }}" class="btn btn-warning btn-xs" title="Download Lembar Absensi">
