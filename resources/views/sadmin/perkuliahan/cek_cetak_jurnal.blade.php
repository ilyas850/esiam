...
<body>
    ...
    <table width="100%">
     <tr>
       <td width="34%" align=left><span style="font-size:85%">*) Validasi dilakukan oleh Prodi (Sekretaris Prodi) setiap hari</span></td>
       <td width="33%" align=center><span style="font-size:85%"></span></td>
       <td width="33%" align=center><span style="font-size:85%">Cikarang, {{$d}} {{$m}} {{$y}}</span></td>
     </tr>
    </table>
	<table width="100%">
		<tr>
            ...
            <td width="33%" align=center><span style="font-size:85%"></span></td>
      		<td width="33%" align=center><span style="font-size:85%">Kepala Program Studi</span><br><span style="font-size:85%">{{$bap->prodi}}</span></td>
		</tr>
	</table>
	<br><br><br><br>
	<table width="100%">
		<tr>
            <td width="34%" align=center><span style="font-size:85%"></span></td>
            <td width="33%" align=center><span style="font-size:85%"></span></td>
			<td width="33%" align=center><span style="font-size:85%">(..........................................)</td>
		</tr>
	</table>
    <table width="100%">
		<tr>
