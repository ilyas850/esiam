    ...
    <table border="1" width="100%">
        <thead>
            <tr>
              ...
              <th ><center>Jam Validasi</center></th>
        ...
        <tbody>
            ...
            @foreach ($data as $item)
                <tr>
                  ...
                  <td><center>{{ $item->val_jam_mulai ? date('H:i', strtotime($item->val_jam_mulai)) : '' }} - {{ $item->val_jam_selesai ? date('H:i', strtotime($item->val_jam_selesai)) : '' }}</center></td>
      ...
      <table width="100%">
       <tr>
         <td width="67%"><span style="font-size:85%">*) Validasi dilakukan oleh Prodi (Sekretaris Prodi) setiap hari</span></td>
         <td width="33%"><span style="font-size:85%">Cikarang,</span></td>
       </tr>
      </table>
      <table width="100%">
        <tr>
          <td width="67%"><span style="font-size:85%">Dosen Pengampu</span></td>
          <td width="33%"><span style="font-size:85%">Kepala Program Studi</span><br><span style="font-size:85%">{{$bap->prodi}}</span></td>
        </tr>
      </table>
      <br><br><br>
      <table width="100%">
        <tr>
          <td width="67%" ><span style="font-size:85%">{{$bap->nama}}, {{$bap->akademik}}</span></td>
          <td width="33%" ><span style="font-size:85%">{{$cekkprd->nama}}, {{$cekkprd->akademik}}</td>
        </tr>
      </table>
    <script>
        window.print();
