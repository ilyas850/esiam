...
@section('content_header')
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/cek_rekapan_kprd/{{$dtbp->id_kurperiode}}">Cek BAP</a></li>
...
@section('content')
    <section class="content">
        <div class="box box-info">
            <div class="box-body">
                <a class="btn btn-success" href="/cek_rekapan_kprd/{{$dtbp->id_kurperiode}}">Kembali</a>

                <a class="btn btn-warning" href="/cek_print_bap_kprd/{{$dtbp->id_bap}}" target="_blank"><i class="fa fa-print"></i> PRINT</a>
