...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('rekap_perkuliahan_kprd') }}"> Rekap perkuliahan</a></li>
            <li><a href="/cek_rekapan_kprd/{{ $bap->id_kurperiode }}">Cek BAP</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="/cek_rekapan_kprd/{{ $bap->id_kurperiode }}" class="btn btn-default btn-sm">
                        <i class="fa fa-arrow-left"></i> Kembali ke Cek BAP
                    </a>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <table class="table table-condensed table-borderless" style="margin-bottom: 0;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $bap->nama }}, {{ $bap->akademik }}@if(!empty($nama_dosen_2)) / {{ $nama_dosen_2 }}@endif</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6 col-sm-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="/print_jurnal_cek_kprd/{{ $bap->id_kurperiode }}" class="btn btn-success btn-sm" target="_blank">
                        <i class="fa fa-print"></i> Print
                    </a>
                    <a href="/download_jurnal_kprd/{{ $bap->id_kurperiode }}" class="btn btn-info btn-sm">
                ...
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr class="bg-gray" style="font-weight: 600;">
                            ...
                            <th class="text-center" style="width: 120px;">Payroll Check</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($data as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">{{ $item->payroll_check }}</td>
                            </tr>
                        @empty
                            <tr>
