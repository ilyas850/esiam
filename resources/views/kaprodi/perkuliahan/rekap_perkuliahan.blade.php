      ...
      <div class="box-body">
        <table id="example1" class="table">
          ...
          <tbody>
            ...
            @foreach ($data as $key)
              <tr>
                <td><span style="font-size:95%"><center>{{$no++}}</center></span></td>
                <td><span style="font-size:95%">{{$key->kode}}/{{$key->makul}}</span></td>
                <td><span style="font-size:95%"><center>{{$key->akt_sks_teori + $key->akt_sks_praktek}}</center></span></td>
                ...
                <td><center><span style="font-size:95%">
                ...
                <td><center>
                  <a href="cek_rekapan_kprd/{{$key->id_kurperiode}}" class="btn btn-info btn-xs">Cek BAP</a>
                </center></td>
              </tr>
            @endforeach
          </tbody>
