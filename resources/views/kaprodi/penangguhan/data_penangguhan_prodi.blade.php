    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Data Penangguhan Prodi</h3>
            </div>
            <div class="box-body">
                                ...
                                <td align="center">
                                    ...
                                    @elseif ($item->validasi_dsn_pa == 'SUDAH')
                                        @if ($item->validasi_kaprodi == 'BELUM')
                                            <a href="/val_penangguhan_prodi/{{ $item->id_penangguhan_trans }}"
                                                class="btn btn-info btn-xs">Validasi</a>
                                        @elseif ($item->validasi_kaprodi == 'SUDAH')
                                            <a href="/batal_val_penangguhan_prodi/{{ $item->id_penangguhan_trans }}"
