...
@section('content_header')
    <section class="content-header">
        ...
        <li><a href="{{ url('history_makul_kprd') }}"> History Matakuliah yang diampu</a></li>
        <li><a href="/view_bap_his_kprd/{{$bap->id_kurperiode}}">History BAP</a></li>
...
<section class="content">
    <div class="box box-info">
        ...
        <div class="box-body">
            <a href="/print_jurnal_kprd/{{$bap->id_kurperiode}}" class="btn btn-success" target="_blank">Print</a>
            <br><br>
