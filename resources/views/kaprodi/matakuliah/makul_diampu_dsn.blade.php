                        ...
                        @foreach ($makul as $item)
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <span style="font-size: 15px; font-weight: bold; color: #3c8dbc;">{{ $item->makul }}</span><br>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <div style="margin-bottom: 5px;">
                                        ...
                                        @else
                                            <div class="btn-group">
                                                <a href="/edit_rps_kprd/{{ $item->id_kurperiode }}" class="btn btn-info btn-xs"
                                                    title="Edit RPS"><i class="fa fa-pencil"></i> RPS</a>
                                                <a href="/cekmhs_dsn_kprd/{{ $item->id_kurperiode }}" class="btn btn-primary btn-xs"
                                    ...
                                    <div class="btn-group">
                                        <a href="/export_xlsnilai_kprd/{{ $item->id_kurperiode }}" class="btn btn-default btn-xs"
                                            title="Export Excel">
                                            <i class="fa fa-file-excel-o text-green"></i>
                                        </a>
                                        <a href="/unduh_pdf_nilai_kprd/{{ $item->id_kurperiode }}" class="btn btn-default btn-xs"
                                            title="Export PDF">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="cetak_soal_uts" class="form-control" required>
                                                        @if ($item->cetak_soal_uts)
                                                            <option value="{{ $item->cetak_soal_uts }}">{{ $item->cetak_soal_uts }}</option>
                                                        @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="cetak_soal_uas" class="form-control" required>
                                                        @if ($item->cetak_soal_uas)
                                                            <option value="{{ $item->cetak_soal_uas }}">{{ $item->cetak_soal_uas }}</option>
                                                        @endif
                                                        <option value="YA">YA</option>
                                                        <option value="TIDAK">TIDAK</option>
                                                    </select>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" readonly cols="20" rows="5">{{ $item->komentar_uts }}</textarea>
                                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Isi Komentar:</label>
                                                <textarea class="form-control" readonly cols="20" rows="5">{{ $item->komentar_uas }}</textarea>
                                            </div>
                                            <button type="button" class="btn btn-default pull-right"
                                                data-dismiss="modal">Tutup</button>
                                            <div class="clearfix"></div>
