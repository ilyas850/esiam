                ...
                <tbody>
                    ...
                    @foreach ($makul as $item)
                        <tr>
                            ...
                            <td><center>
                            <a href="cekmhs_dsn_kprd/{{$item->id_kurperiode}}" class="btn btn-info btn-xs">Cek Mahasiswa</a>
                            </center></td>
                            <td><center>
                            ...
                            <td><center>
                                <a href="entri_bap_kprd/{{$item->id_kurperiode}}" class="btn btn-warning btn-xs"> Entri Absen</a>
                            </center></td>
                        </tr>
                    @endforeach
                </tbody>
