...
<section class="content">
    <div class="box box-info">
        ...
        <form action="{{url('save_nilai_AKHIR_kprd')}}" method="post">
          {{ csrf_field() }}
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th><center>Nilai AKHIR ANGKA</center></th>
                    ...
                    @foreach ($ck as $item)
                        <tr>
                            ...
                            <td><center>
                              ...
                              <input type="hidden" name="id_student[]" value="{{$item->id_student}},{{$item->id_kurtrans}}">
                                <input type="hidden" name="id_studentrecord[]" value="{{$item->id_studentrecord}}">
                                <input type="text" name="nilai_AKHIR_angka[]" value="{{$item->nilai_AKHIR_angka}}">
                              @endif
                            </center></td>
                        </tr>
                    @endforeach
