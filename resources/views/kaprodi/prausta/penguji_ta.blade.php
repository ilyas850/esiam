                                    ...
                                    <center>
                                        ...
                                        @elseif($key->acc_seminar_sidang == 'TERIMA')
                                            ...
                                            @elseif ($key->id_dosen_pembimbing == $id && $key->nilai_1 != null)
                                                @if ($key->validasi == 0)
                                                    <a class="btn btn-success btn-xs"
                                                        href="/edit_nilai_ta_by_dospem_kprd/{{ $key->id_settingrelasi_prausta }}">Edit
                                                        nilai</a>
                                            ...
                                            @elseif($key->id_dosen_penguji_1 == $id && $key->nilai_2 != null)
                                                @if ($key->validasi == 0)
                                                    <a class="btn btn-success btn-xs"
                                                        href="/edit_nilai_ta_by_dospeng1_kprd/{{ $key->id_settingrelasi_prausta }}">Edit
                                                        nilai</a>
                                                @elseif ($key->validasi == 1)
                                                    <span class="badge bg-yellow">Sudah divalidasi </span>
                                                @endif
                                            @elseif($key->id_dosen_penguji_2 == $id && $key->nilai_3 != null)
                                                @if ($key->validasi == 0)
                                                    <a class="btn btn-success btn-xs"
                                                        href="/edit_nilai_ta_by_dospeng2_kprd/{{ $key->id_settingrelasi_prausta }}">Edit
                                                        nilai</a>
                                                @elseif ($key->validasi == 1)
                                                    <span class="badge bg-yellow">Sudah divalidasi </span>
                                                @endif
