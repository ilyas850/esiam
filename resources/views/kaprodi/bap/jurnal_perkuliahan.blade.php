                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <center>{{ $item->tanggal ? date('Y-m-d', strtotime($item->tanggal)) : '' }}</center>
                                </td>
                                <td>
                                    <center>{{ $item->jam_mulai ? date('H:i', strtotime($item->jam_mulai)) : '' }} - {{ $item->jam_selsai ? date('H:i', strtotime($item->jam_selsai)) : '' }}</center>
                                </td>
                                <td>
                                    <center>{{ $item->val_jam_mulai ? date('H:i', strtotime($item->val_jam_mulai)) : '' }} - {{ $item->val_jam_selesai ? date('H:i', strtotime($item->val_jam_selesai)) : '' }}</center>
                                </td>
                                ...
                                <td>
                                    <center>{{ $item->payroll_check }}</center>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
