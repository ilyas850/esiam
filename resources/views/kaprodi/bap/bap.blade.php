        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-md-12">
                        <a href="/input_bap_kprd/{{ $bap->id_kurperiode }}" class="btn btn-success btn-flat">
                            <i class="fa fa-plus"></i> Input BAP
                        </a>
                        <a href="/sum_absen_kprd/{{ $bap->id_kurperiode }}" class="btn btn-info btn-flat">
                            <i class="fa fa-list-alt"></i> Absensi Perkuliahan
                        </a>
                        <a href="/jurnal_bap_kprd/{{ $bap->id_kurperiode }}" class="btn btn-warning btn-flat">
                                ...
                                <tr>
                                        ...
                                        @if ($item->kurang_jam != null)
                                            <div style="margin-top: 5px; color: red;">
                                                <small><i class="fa fa-warning"></i> Kurang:
                                                    {{ Carbon\Carbon::parse($item->kurang_jam)->format('H:i') }}</small>
                                            </div>
                                        @endif
                                    </td>
                                        ...
                                        @if ($item->komentar != null)
                                            <div style="margin-top: 5px;">
                                                <button class="btn btn-warning btn-xs" data-toggle="modal"
                                                    data-target="#modalTambahKomentar{{ $item->id_rps }}"
                                            ...
                                            <tr>
                                                <td class="text-center" style="border-right: 1px solid #ddd;">
                                                    <span class="text-green"
                                                        style="font-weight: bold; font-size: 16px;">{{ $item->hadir }}</span><br><small>Hadir</small>
                                                </td>
                                                <td class="text-center">
                                                    <span class="text-red"
                                                        style="font-weight: bold; font-size: 16px;">{{ $item->tidak_hadir }}</span><br><small>Absen</small>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="/view_bap_kprd/{{ $item->id_bap }}"
                                            ...
                                            @if ($item->tanggal_validasi == '2001-01-01' or $item->tanggal_validasi == null)
                                                <a href="/edit_bap_kprd/{{ $item->id_bap }}"
                                                    class="btn btn-success btn-xs btn-flat" title="Edit BAP">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                                <a href="/delete_bap_kprd/{{ $item->id_bap }}"
