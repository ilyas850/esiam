...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="/simpanedit_bap_kprd/{{ $id }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" name="praktikum" @if($cek_mk->akt_sks_praktek > 0) required @endif>{{ $bap->praktikum }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
