        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-warning btn-sm btn-flat" href="/print_bap_kprd/{{ $dtbp->id_bap }}" target="_blank">
                        <i class="fa fa-print"></i> Cetak BAP
                    </a>
                    <a class="btn btn-default btn-sm btn-flat" href="/entri_bap_kprd/{{ $dtbp->id_kurperiode }}">
            ...
            <div class="box-footer">
                <a class="btn btn-default btn-flat" href="/entri_bap_kprd/{{ $dtbp->id_kurperiode }}">
