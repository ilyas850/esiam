                                ...
                                <td>
                                    <center>
                                        @if ($key->validasi == 'BELUM')
                                            <a href="/val_bim_skripsi_kprd/{{ $key->id_transbimb_prausta }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/komentar_bimbingan_skripsi_kprd/{{ $key->id_transbimb_prausta }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Draft Laporan Skripsi</span>
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Laporan Akhir Skripsi</span>
                        <span class="info-box-number">
