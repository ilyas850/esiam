...
@section('content')
    <section class="content">
        <div class="box box-primary">
            <form action="{{ url('simpan_data_magang2') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Kategori Magang<font color="red-text">*</font></label>
                        ...
                        <div class="col-md-4">
                            <label>Tanggal Mulai Magang<font color="red-text">*</font></label>
