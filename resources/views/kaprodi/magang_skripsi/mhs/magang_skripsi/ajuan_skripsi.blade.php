...
@section('content')
    <section class="content">
        <div class="box box-primary">
            <form action="{{ url('simpan_ajuan_skripsi') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Kategori <font color="red-text">*</font></label>
                        ...
                        <div class="col-md-4">
                            <label>Tanggal Mulai Skripsi<font color="red-text">*</font></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Judul Skripsi<font color="red-text">*</font></label>
