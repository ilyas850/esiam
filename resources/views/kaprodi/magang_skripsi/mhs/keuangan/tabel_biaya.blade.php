                        ...
                        @foreach ($itembayar as $item)
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    @elseif ($item->item == 'Magang 1')
                                        @currency ( $biaya->magang1 )
                                    @elseif ($item->item == 'Magang 2')
                                        @currency ( $biaya->magang2 )
                                ...
                                <td align="right">
                                    ...
                                    @elseif($cb != null)
                                        ...
                                        @elseif ($item->item == 'Magang 1')
                                            @currency ( $biaya->magang1 - ($biaya->magang1 * $cb->magang1) / 100 )
                                        @elseif ($item->item == 'Magang 2')
                                            @currency ( $biaya->magang2 - ($biaya->magang2 * $cb->magang2) / 100 )
                                        @elseif ($item->item == 'Seminar')
                                ...
                                <td align="right">
                                    ...
                                    @elseif ($item->item == 'Magang 1')
                                        @currency($sisamagang1)
                                    @elseif ($item->item == 'Magang 2')
                                        @currency($sisamagang2)
                                    @elseif ($item->item == 'Seminar')
                                ...
                                <td align="right">
                                    @if ($cb == null)
                                        @if ($item->item == 'Pendaftaran')
                                            @currency($biaya->daftar - $sisadaftar)
                                        @elseif ($item->item == 'Perlengkapan Awal')
                                            @currency($biaya->awal - $sisaawal)
                                        @elseif ($item->item == 'Dana Pengembangan')
                                            @currency($biaya->dsp - $sisadsp)
                                        @elseif ($item->item == 'Biaya SPP 1')
                                            @currency($biaya->spp1 - $sisaspp1)
                                        @elseif ($item->item == 'Biaya SPP 2')
                                            @currency($biaya->spp2 - $sisaspp2)
                                        @elseif ($item->item == 'Biaya SPP 3')
                                            @currency($biaya->spp3 - $sisaspp3)
                                        @elseif ($item->item == 'Biaya SPP 4')
                                            @currency($biaya->spp4 - $sisaspp4)
                                        @elseif ($item->item == 'Biaya SPP 5')
                                            @currency($biaya->spp5 - $sisaspp5)
                                        @elseif ($item->item == 'Biaya SPP 6')
                                            @currency($biaya->spp6 - $sisaspp6)
                                        @elseif ($item->item == 'Biaya SPP 7')
                                            @currency($biaya->spp7 - $sisaspp7)
                                        @elseif ($item->item == 'Biaya SPP 8')
                                            @currency($biaya->spp8 - $sisaspp8)
                                        @elseif ($item->item == 'Biaya SPP 9')
                                            @currency($biaya->spp9 - $sisaspp9)
                                        @elseif ($item->item == 'Biaya SPP 10')
                                            @currency($biaya->spp10 - $sisaspp10)
                                        @elseif ($item->item == 'Biaya SPP 11')
                                            @currency($biaya->spp11 - $sisaspp11)
                                        @elseif ($item->item == 'Biaya SPP 12')
                                            @currency($biaya->spp12 - $sisaspp12)
                                        @elseif ($item->item == 'Biaya SPP 13')
                                            @currency($biaya->spp13 - $sisaspp13)
                                        @elseif ($item->item == 'Biaya SPP 14')
                                            @currency($biaya->spp14 - $sisaspp14)
                                        @elseif ($item->item == 'Prakerin')
                                            @currency($biaya->prakerin - $sisaprakerin)
                                        @elseif ($item->item == 'Magang 1')
                                            @currency($biaya->magang1 - $sisamagang1)
                                        @elseif ($item->item == 'Magang 2')
                                            @currency($biaya->magang2 - $sisamagang2)
                                        @elseif ($item->item == 'Seminar')
                                            @currency($biaya->seminar - $sisaseminar)
                                        @elseif ($item->item == 'Sidang')
                                            @currency($biaya->sidang - $sisasidang)
                                        @elseif ($item->item == 'Wisuda')
                                            @currency ( $biaya->wisuda - $sisawisuda)
                                        @endif
                                    @elseif($cb != null)
                                        @if ($item->item == 'Pendaftaran')
                                        ...
                                        @elseif ($item->item == 'Prakerin')
                                            @currency($biaya->prakerin - ($biaya->prakerin * $cb->prakerin) / 100 - $sisaprakerin)
                                        @elseif ($item->item == 'Magang 1')
                                            @currency($biaya->magang1 - ($biaya->magang1 * $cb->magang1) / 100 - $sisamagang1)
                                        @elseif ($item->item == 'Magang 2')
                                            @currency($biaya->magang2 - ($biaya->magang2 * $cb->magang2) / 100 - $sisamagang2)
                                        @elseif ($item->item == 'Seminar')
                                            @currency($biaya->seminar - ($biaya->seminar * $cb->seminar) / 100 - $sisaseminar)
                                        @elseif ($item->item == 'Sidang')
