...
@section('content_header')
    <section class="content-header">
        <h1>Data Mahasiswa Tidak Aktif</h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('yayasan_home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Mahasiswa Tidak Aktif</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-times"></i> Daftar Mahasiswa Tidak Aktif</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    @foreach($mahasiswa as $index => $mhs)
                                        <tr>
                                            ...
                                            <td>{{ $mhs->nim }}</td>
                                            <td>{{ $mhs->nama }}</td>
                                            <td>{{ $mhs->nama_prodi }}{{ $mhs->konsentrasi ? ' - ' . $mhs->konsentrasi : '' }}
                                            </td>
