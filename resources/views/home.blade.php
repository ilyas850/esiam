        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-info">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="/new_pwd_user/{{Auth::user()->username}}">
                    {{ csrf_field() }}
                    <input id="role" type="hidden" class="form-control" name="role" value="3">
                    <div class="box-body">
                      <center>
                      <a class="btn btn-warning" href="pwd/{{ Auth::user()->id }}" class="btn btn-default btn-flat">Klik disini untuk ganti password !!!</a>
                    </center>
                    </div>
                  </form>
                </div>
