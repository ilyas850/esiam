...
@section('content')
    <section class="content">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <form action="{{ url('download_report_edom_by_makul_gugusmutu') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <form action="detail_edom_makul_gugusmutu" method="POST">
                                            {{ csrf_field() }}
                                ...
                                <td>
                                    <center>
                                        <form action="download_detail_edom_makul_gugusmutu" method="POST">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id_kurperiode" value="{{ $item->id_kurperiode }}">
                                            <input type="hidden" name="id_periodetahun" value="{{ $idperiodetahun }}">
                                            <input type="hidden" name="id_periodetipe" value="{{ $idperiodetipe }}">
