                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        @if ($data->judul_prausta == null)
                            <a class="btn btn-danger" href="pengajuan_skripsi/{{ $data->id_settingrelasi_prausta }}">Masukan
                                Data
                                Skripsi</a>
                        @elseif ($data != null)
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Tanggal Mulai Skripsi</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Jam Selesai Sidang</label>
                                            <input type="text" class="form-control"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Update Skripsi</h5>
                                            </div>
                                            <div class="modal-body">
                                                <form action="/put_sempro/{{ $data->id_settingrelasi_prausta }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                                    <div class="form-group">
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                <a href="/download_bimbingan_skripsi_mhs/{{ $data->id_settingrelasi_prausta }}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            {{-- <td align="center">
                                                                ...
                                                                @elseif ($key->file_bimbingan != null)
                                                                    <a href="/File Bimbingan SKRIPSI/{{ Auth::user()->id_user }}/{{ $key->file_bimbingan }}"
                                                        ...
                                                        <div class="modal fade"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            action="/edit_bim_sempro/{{ $key->id_transbimb_prausta }}"
                                ...
                                @elseif ($jml_bim >= 2)
                                    @if ($hasil_skripsi == 0 or $hasil_skripsi > 0)
                                            ...
                                            <form class="" action="{{ url('ajukan_skripsi_d4') }}" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <input type="hidden" name="id_settingrelasi_prausta"
                                                            value="{{ $data->id_settingrelasi_prausta }}">
                                                        <button type="submit" class="btn btn-info">Ajukan Sidang
                                                            Skripsi</button>
                                                    </div>
                                                </div>
                                            </form>
                                        @elseif ($data->acc_seminar_sidang == 'PENGAJUAN')
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="info-box">
                                                        ...
                                                        <div class="info-box-content">
                                                            <span class="info-box-text">Laporan SKRIPSI</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="info-box">
                                                        <form action="{{ url('ajukan_skripsi_d4') }}" method="post"
                                                            enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id_settingrelasi_prausta"
                                                                value="{{ $data->id_settingrelasi_prausta }}">
                                    ...
                                    @else
                                        <span class="badge bg-red">Maaf syarat keuangan anda belum memenuhi untuk
                                            pengajuan sidang skripsi</span>
                                    @endif
                                @endif
                            </div>
                            <div class="tab-pane" id="tab_4">
                                @if ($data->acc_seminar_sidang == null)
                                    <span class="badge bg-red">Belum Mengajukan Sidang Skripsi</span>
                                @elseif ($data->acc_seminar_sidang == 'PENGAJUAN')
                                    <span class="badge bg-red">Menunggu Acc. Dosen Pembimbing</span>
                                @elseif ($data->acc_seminar_sidang == 'TERIMA')
                                    @if ($data->tanggal_selesai == null)
                                        <span class="badge bg-red">Menunggu Jadwal Sidang Skripsi</span>
                                    @else
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="info-box">
