            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Data Magang</a></li>
                        <li><a href="#tab_2" data-toggle="tab">Data Bimbingan Magang</a></li>
                        <li><a href="#tab_3" data-toggle="tab">Pengajuan Seminar Magang</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Upload Draft Laporan Magang</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Nilai Magang</a></li>
                    </ul>
