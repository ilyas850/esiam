                    ...
                    <div class="tab-content">
                        ...
                        @elseif ($cekdata != null)
                            <div class="tab-pane active" id="tab_1">
                                <form action="edit_ajuan_prakerin/{{ $usta->id_settingrelasi_prausta }}" method="post"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $usta->kode_prausta }} - {{ $usta->nama_prausta }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $usta->nama }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>NIM</label>
                                                <input type="text" class="form-control" value="{{ $usta->nim }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $usta->prodi }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="2" cols="60"
                                                    name="judul_prausta">{{ $usta->judul_prausta }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $usta->tempat_prausta }}" name="tempat_prausta">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @elseif ($usta->file_nilai_pembim != NULL)
                                                    <a href="/File Nilai Pembimbing/{{ Auth::user()->id_user }}/{{ $usta->file_nilai_pembim }}"
                                                        target="_blank"> File Nilai Pembimbing</a>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @elseif ($usta->file_kartu_bim != NULL)
                                                    <a href="/File Kartu Bimbingan/{{ Auth::user()->id_user }}/{{ $usta->file_kartu_bim }}"
                                                        target="_blank"> File Kartu Bimbingan</a>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @elseif ($usta->file_surat_balasan != NULL)
                                                    <a href="/File Surat Balasan/{{ Auth::user()->id_user }}/{{ $usta->file_surat_balasan }}"
                                                        target="_blank"> File Susat Balasan</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $usta->tanggal_mulai }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="remark_bimbingan"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-primary">Perbarui Data</button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane" id="tab_3">
                                @if ($jml_bim < 6)
                                    maaf jumlah bimbingan anda kurang dari 6
                                @elseif ($jml_bim >= 6)
