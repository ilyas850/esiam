                ...
                <div class="row">
                    <div class="col-xs-2">
                        <button type="button" class="btn btn-success mr-5" data-toggle="modal"
                            data-target="#addcutipengajuan">
                            Input Data Pengajuan Cuti
                        </button>
                    </div>
                </div>
                <br>
                <div class="modal fade" id="addcutipengajuan" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form method="post" action="{{ url('post_pengajuan_cuti') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Input Data Pengajuan Cuti</h5>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Pernah Ambil Cuti Sebelumnya</label>
                                                <select name="cuti_sebelumnya" class="form-control" required>
                                                    <option></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="alamat" class="form-control" cols="10" rows="5" required></textarea>
                                    </div>
                                </div>
                ...
                <table id="example8" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2">
                                <center>Alamat selama Cuti</center>
                            </th>
                            <th colspan="4">
                                ...
                                <td align="center">
                                    @if ($item->val_bauk == 'BELUM')
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                            data-target="#modalUpdateCuti{{ $item->id_trans_pengajuan }}"
                                            title="klik untuk edit"><i class="fa fa-edit"></i></button>
                                        <a class="btn btn-danger btn-xs"
                                            href="/batal_pengajuan_cuti/{{ $item->id_trans_pengajuan }}"
                                            onclick="return confirm('anda yakin akan mebatalkan ini ?')"><i
                                                class="fa fa-trash"></i></a>
                                    @endif
                                </td>
                            </tr>
                            <div class="modal fade" id="modalUpdateCuti{{ $item->id_trans_pengajuan }}" tabindex="-1"
                                aria-labelledby="modalUpdateCuti" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Update Pengajuan Cuti</h5>
                                        </div>
                                        <form action="/put_pengajuan_cuti/{{ $item->id_trans_pengajuan }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Pernah Ambil Cuti Sebelumnya</label>
                                                            <select name="cuti_sebelumnya" class="form-control" required>
                                                                <option value="{{ $item->cuti_sebelumnya }}">
                                                                    {{ $item->cuti_sebelumnya }}</option>
                                                                <option value="YA">YA</option>
                                                                <option value="TIDAK">TIDAK</option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Alamat selama cuti</label>
                                                    <textarea type="text" name="alamat" class="form-control" cols="10" rows="5" required>
                                                        {{ $item->alamat }}
                                                    </textarea>
                                                </div>
                                            </div>
