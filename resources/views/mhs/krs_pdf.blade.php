...
<body>
  ...
  <table  width="100%">
    <tr>
      <td>
        <center><h4><b>KARTU RENCANA STUDI MAHASISWA</b></h4></center>
      </td>
    </tr>
  </table>
  <table width="100%">
  	 <tr>
  			 <td><b><span style="font-size:65%">Nama </span></b></td><td> : </td>
  			 <td><b><span style="font-size:65%"><u>{{ $mhs->nama }}</u></span></b></td>
  			 <td><b><span style="font-size:65%">Kelas</span></b></td><td> : </td>
  			 <td><b><span style="font-size:65%"><u>{{$mhs->kelas}}</span></u></b></td>
  	 </tr>
		 <tr>
			 <td><b><span style="font-size:65%">NIM</span></b></td><td> : </td>
			 <td><b><span style="font-size:65%"><u>{{ $mhs->nim }}</u></span></b></td>
			 <td><b><span style="font-size:65%">Tahun Ajaran</span></b></td><td> : </td>
		 ...
		 <tr>
			 <td><b><span style="font-size:65%">Program Studi</span></b></td><td> : </td>
         ...
         $i = 0;
				...
				@foreach($krs as $item)
				 <tr>
					 ...
					 <td><span style="font-size:50%"><center><b>{{$item->kode}}</center></b></span></td>
           ...
           <td align=center><span style="font-size:50%"><b>{{$item->hari}}, {{$item->jam}}</b></span></td>
  ...
  <span style="font-size:55%">*Note : untuk matakuliah yang mengulang bisa diisi di 3 baris kosong di atas dan diisi oleh dosen pembimbing</span>
	 <br><br>
   <table width="100%">
     <tr>
       <td width="33%" align=center><span style="font-size:65%"></span></td>
       <td width="34%" align=center><span style="font-size:65%"></span></td>
       <td width="33%" align=center><span style="font-size:65%">Cikarang, {{$d}} {{$m}} {{$y}}</span></td>
     </tr>
    </table>
		<table width="100%">
		<tr>
