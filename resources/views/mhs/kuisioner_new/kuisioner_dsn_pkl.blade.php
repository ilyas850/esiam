    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">KUISIONER KEPUASAN MAHASISWA TERHADAP EVALUASI DOSEN PEMBIMBING PRAKTIK KERJA
                    INDUSTRI / PRAKTIK KERJA LAPANGAN </h3>
                <br><br>
                <table width="100%">
                    <tr>
                        <td>Program Studi</td>
            ...
            <div class="box-body ">
                <form action="{{ url('save_kuisioner_dsn_pkl_new') }}" method="post">
                    {{ csrf_field() }}
