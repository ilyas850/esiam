...
<body>
  ...
  <table  width="100%">
    <tr>
      <td>
        <center><h4><b>KARTU HASIL STUDI MAHASISWA (MID-TERM)</b></h4></center>
      </td>
    </tr>
  </table>
  <table width="100%">
  	 <tr>
  			 <td><b><span style="font-size:85%">Nama </span></b></td><td> : </td>
  			 <td><b><span style="font-size:85%"><u>{{ $mhs->nama }}</u></span></b></td>
  			 <td><b><span style="font-size:85%">Kelas</span></b></td><td> : </td>
  			 <td><b><span style="font-size:85%"><u>
               @if ($mhs->idstatus ==1)
                     Reguler A
		 ...
		 <tr>
			 <td><b><span style="font-size:85%">NIM</span></b></td><td> : </td>
			 <td><b><span style="font-size:85%"><u>{{ $mhs->nim }}</u></span></b></td>
			 <td><b><span style="font-size:85%">Tahun Ajaran</span></b></td><td> : </td>
			 <td><b><span style="font-size:85%"><u>
             @foreach ($thn as $TA)
               {{ $TA->periode_tahun }}
             @endforeach
         ...
         $i = 0;
				...
				@foreach($krs as $item)
				 <tr>
					 ...
					 <td><span style="font-size:80%"><center><b>
              @foreach ($mk as $makul)
